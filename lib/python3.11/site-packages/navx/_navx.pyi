...
class AHRS(wpiutil._wpiutil.Sendable):
    ...
    class BoardAxis:
        ...
        __members__: typing.ClassVar[
            dict[str, AHRS.BoardAxis]
        ]  # value = {'kBoardAxisX': <BoardAxis.kBoardAxisX: 0>, 'kBoardAxisY': <BoardAxis.kBoardAxisY: 1>, 'kBoardAxisZ': <BoardAxis.kBoardAxisZ: 2>}
        kBoardAxisX: typing.ClassVar[
            AHRS.BoardAxis
        ]  # value = <BoardAxis.kBoardAxisX: 0>
        kBoardAxisY: typing.ClassVar[
            AHRS.BoardAxis
        ]  # value = <BoardAxis.kBoardAxisY: 1>
        kBoardAxisZ: typing.ClassVar[
            AHRS.BoardAxis
        ]  # value = <BoardAxis.kBoardAxisZ: 2>
    ...
    class SerialDataType:
        ...
        __members__: typing.ClassVar[
            dict[str, AHRS.SerialDataType]
        ]  # value = {'kProcessedData': <SerialDataType.kProcessedData: 0>, 'kRawData': <SerialDataType.kRawData: 1>}
        kProcessedData: typing.ClassVar[
            AHRS.SerialDataType
        ]  # value = <SerialDataType.kProcessedData: 0>
        kRawData: typing.ClassVar[
            AHRS.SerialDataType
        ]  # value = <SerialDataType.kRawData: 1>
        def __eq__(self, other: typing.Any) -> bool: ...
        def __getstate__(self) -> int: ...
        def __hash__(self) -> int: ...
        def __index__(self) -> int: ...
    ...
    @staticmethod
    def create_i2c(
        port: wpilib._wpilib.I2C.Port = ..., update_rate_hz: int = 60
    ) -> AHRS:
        """
    ...
    @typing.overload
    def __init__(
        self, spi_port_id: wpilib._wpilib.SPI.Port, update_rate_hz: int
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
        spi_port_id: wpilib._wpilib.SPI.Port,
        spi_bitrate: int,
        update_rate_hz: int,
    ) -> None: ...
    @typing.overload
    def __init__(
        self, i2c_port_id: wpilib._wpilib.I2C.Port, update_rate_hz: int
    ) -> None: ...
    @typing.overload
    def __init__(
        self,
        serial_port_id: wpilib._wpilib.SerialPort.Port,
        data_type: AHRS.SerialDataType,
        update_rate_hz: int,
    ) -> None: ...
    ...
    def updateDisplacement(
        self, accel_x_g: float, accel_y_g: float, update_rate_hz: int, is_moving: bool
    ) -> None: ...
