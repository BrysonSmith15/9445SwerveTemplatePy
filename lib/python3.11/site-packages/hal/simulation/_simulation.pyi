...
__all__ = [
    ...
    "cancelRoboRioRadioLEDStateCallback",
...
class AnalogTriggerMode:
    ...
    HALSIM_AnalogTriggerAveraged: typing.ClassVar[
        AnalogTriggerMode
    ]  # value = <AnalogTriggerMode.HALSIM_AnalogTriggerAveraged: 3>
    HALSIM_AnalogTriggerDutyCycle: typing.ClassVar[
        AnalogTriggerMode
    ]  # value = <AnalogTriggerMode.HALSIM_AnalogTriggerDutyCycle: 2>
    HALSIM_AnalogTriggerFiltered: typing.ClassVar[
        AnalogTriggerMode
    ]  # value = <AnalogTriggerMode.HALSIM_AnalogTriggerFiltered: 1>
    HALSIM_AnalogTriggerUnassigned: typing.ClassVar[
        AnalogTriggerMode
    ]  # value = <AnalogTriggerMode.HALSIM_AnalogTriggerUnassigned: 0>
    __members__: typing.ClassVar[
        dict[str, AnalogTriggerMode]
    ]  # value = {'HALSIM_AnalogTriggerUnassigned': <AnalogTriggerMode.HALSIM_AnalogTriggerUnassigned: 0>, 'HALSIM_AnalogTriggerFiltered': <AnalogTriggerMode.HALSIM_AnalogTriggerFiltered: 1>, 'HALSIM_AnalogTriggerDutyCycle': <AnalogTriggerMode.HALSIM_AnalogTriggerDutyCycle: 2>, 'HALSIM_AnalogTriggerAveraged': <AnalogTriggerMode.HALSIM_AnalogTriggerAveraged: 3>}
...
def cancelPowerDistributionCurrentCallback(
    index: int, channel: int, uid: int
) -> None: ...
...
def getJoystickButtons(
    joystickNum: int, buttons: hal._wpiHal.JoystickButtons
) -> None: ...
def getJoystickCounts(stick: int) -> tuple[int, int, int]: ...
def getJoystickDescriptor(
    joystickNum: int, descriptor: hal._wpiHal.JoystickDescriptor
) -> None: ...
...
def getREVPHCompressorConfigType(
    index: int,
) -> hal._wpiHal.REVPHCompressorConfigType: ...
...
def setAccelerometerRange(
    index: int, range: hal._wpiHal.AccelerometerRange
) -> None: ...
...
def setAddressableLEDData(
    index: int, data: hal._wpiHal.AddressableLEDData, length: int
) -> None: ...
...
def setAnalogInAccumulatorInitialized(
    index: int, accumulatorInitialized: int
) -> None: ...
...
def setDriverStationAllianceStationId(
    allianceStationId: hal._wpiHal.AllianceStationID,
) -> None: ...
...
def setPowerDistributionAllCurrents(
    index: int, currents: float, length: int
) -> None: ...
...
def setREVPHCompressorConfigType(
    index: int, configType: hal._wpiHal.REVPHCompressorConfigType
) -> None: ...
