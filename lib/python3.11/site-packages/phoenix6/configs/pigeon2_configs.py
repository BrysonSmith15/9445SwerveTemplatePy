...
class Pigeon2Configuration:
    ...
    def with_mount_pose(
        self, new_mount_pose: MountPoseConfigs
    ...
    def with_pigeon2_features(
        self, new_pigeon2_features: Pigeon2FeaturesConfigs
    ) -> "Pigeon2Configuration":
        """
    ...
    * Class description for the Pigeon 2 IMU sensor that measures orientation.
    ...
    def set_yaw(self, new_value: degree, timeout_seconds: second = 0.050) -> StatusCode:
        ...
        Native.instance().c_ctre_phoenix6_serialize_double(
            SpnValue.PIGEON2_SET_YAW.value, new_value, ctypes.byref(value)
        )
    ...
    def clear_sticky_fault_bootup_accelerometer(
        ...
        value = ctypes.c_char_p()
        Native.instance().c_ctre_phoenix6_serialize_double(
            SpnValue.CLEAR_STICKY_FAULT_PIGEON2_BOOTUP_ACCEL.value,
            0,
            ctypes.byref(value),
        )
        if value.value is not None:
    ...
    def clear_sticky_fault_bootup_gyroscope(
        ...
        value = ctypes.c_char_p()
        Native.instance().c_ctre_phoenix6_serialize_double(
            SpnValue.CLEAR_STICKY_FAULT_PIGEON2_BOOTUP_GYROS.value,
            0,
            ctypes.byref(value),
        )
        if value.value is not None:
    ...
    def clear_sticky_fault_bootup_magnetometer(
        ...
        value = ctypes.c_char_p()
        Native.instance().c_ctre_phoenix6_serialize_double(
            SpnValue.CLEAR_STICKY_FAULT_PIGEON2_BOOTUP_MAGNE.value,
            0,
            ctypes.byref(value),
        )
        if value.value is not None:
    ...
    def clear_sticky_fault_boot_into_motion(
        ...
        value = ctypes.c_char_p()
        Native.instance().c_ctre_phoenix6_serialize_double(
            SpnValue.CLEAR_STICKY_FAULT_PIGEON2_BOOT_INTO_MOTION.value,
            0,
            ctypes.byref(value),
        )
        if value.value is not None:
    ...
    def clear_sticky_fault_data_acquired_late(
        ...
        value = ctypes.c_char_p()
        Native.instance().c_ctre_phoenix6_serialize_double(
            SpnValue.CLEAR_STICKY_FAULT_PIGEON2_DATA_ACQUIRED_LATE.value,
            0,
            ctypes.byref(value),
        )
        if value.value is not None:
    ...
    def clear_sticky_fault_loop_time_slow(
        ...
        value = ctypes.c_char_p()
        Native.instance().c_ctre_phoenix6_serialize_double(
            SpnValue.CLEAR_STICKY_FAULT_PIGEON2_LOOP_TIME_SLOW.value,
            0,
            ctypes.byref(value),
        )
        if value.value is not None:
    ...
    def clear_sticky_fault_saturated_magnetometer(
        ...
        value = ctypes.c_char_p()
        Native.instance().c_ctre_phoenix6_serialize_double(
            SpnValue.CLEAR_STICKY_FAULT_PIGEON2_SATURATED_MAGNE.value,
            0,
            ctypes.byref(value),
        )
        if value.value is not None:
    ...
    def clear_sticky_fault_saturated_accelerometer(
        ...
        value = ctypes.c_char_p()
        Native.instance().c_ctre_phoenix6_serialize_double(
            SpnValue.CLEAR_STICKY_FAULT_PIGEON2_SATURATED_ACCEL.value,
            0,
            ctypes.byref(value),
        )
        if value.value is not None:
    ...
    def clear_sticky_fault_saturated_gyroscope(
        ...
        value = ctypes.c_char_p()
        Native.instance().c_ctre_phoenix6_serialize_double(
            SpnValue.CLEAR_STICKY_FAULT_PIGEON2_SATURATED_GYROS.value,
            0,
            ctypes.byref(value),
        )
        if value.value is not None:
