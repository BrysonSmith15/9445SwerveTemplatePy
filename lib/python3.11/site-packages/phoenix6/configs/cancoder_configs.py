...
class CANcoderConfiguration:
    ...
    def with_magnet_sensor(
        self, new_magnet_sensor: MagnetSensorConfigs
    ...
    * relative position along with filtered velocity.
    ...
    def set_position(
        ...
        Native.instance().c_ctre_phoenix6_serialize_double(
            SpnValue.CANCODER_SET_SENSOR_POSITION.value, new_value, ctypes.byref(value)
        )
    ...
    def clear_sticky_fault_bad_magnet(
        ...
        value = ctypes.c_char_p()
        Native.instance().c_ctre_phoenix6_serialize_double(
            SpnValue.CLEAR_STICKY_FAULT_CANCODER_BAD_MAGNET.value,
            0,
            ctypes.byref(value),
        )
        if value.value is not None:
