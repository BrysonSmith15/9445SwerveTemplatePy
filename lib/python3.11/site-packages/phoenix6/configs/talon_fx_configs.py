...
class TalonFXConfiguration:
    ...
    def __init__(self):
        ...
        self.differential_sensors: DifferentialSensorsConfigs = (
        ...
        self.differential_constants: DifferentialConstantsConfigs = (
        ...
        self.hardware_limit_switch: HardwareLimitSwitchConfigs = (
        ...
        self.software_limit_switch: SoftwareLimitSwitchConfigs = (
    ...
    def with_motor_output(
        self, new_motor_output: MotorOutputConfigs
    ...
    def with_current_limits(
        self, new_current_limits: CurrentLimitsConfigs
    ) -> "TalonFXConfiguration":
        """
    ...
    def with_torque_current(
        self, new_torque_current: TorqueCurrentConfigs
    ) -> "TalonFXConfiguration":
        """
    ...
    def with_differential_sensors(
        self, new_differential_sensors: DifferentialSensorsConfigs
    ) -> "TalonFXConfiguration":
        """
    ...
    def with_differential_constants(
        self, new_differential_constants: DifferentialConstantsConfigs
    ) -> "TalonFXConfiguration":
        """
    ...
    def with_open_loop_ramps(
        self, new_open_loop_ramps: OpenLoopRampsConfigs
    ) -> "TalonFXConfiguration":
        """
    ...
    def with_closed_loop_ramps(
        self, new_closed_loop_ramps: ClosedLoopRampsConfigs
    ) -> "TalonFXConfiguration":
        """
    ...
    def with_hardware_limit_switch(
        self, new_hardware_limit_switch: HardwareLimitSwitchConfigs
    ) -> "TalonFXConfiguration":
        """
    ...
    def with_software_limit_switch(
        self, new_software_limit_switch: SoftwareLimitSwitchConfigs
    ) -> "TalonFXConfiguration":
        """
    ...
    def with_motion_magic(
        self, new_motion_magic: MotionMagicConfigs
    ) -> "TalonFXConfiguration":
        """
    ...
    def with_custom_params(
        self, new_custom_params: CustomParamsConfigs
    ) -> "TalonFXConfiguration":
        """
    ...
    def with_closed_loop_general(
        self, new_closed_loop_general: ClosedLoopGeneralConfigs
    ) -> "TalonFXConfiguration":
        """
...
class TalonFXConfigurator(ParentConfigurator):
    ...
    * Class description for the Talon FX integrated motor controller.
    ...
    def refresh(
        self, configs: SupportsSerialization, timeout_seconds: second = 0.050
    ) -> StatusCode:
        """
    ...
    def apply(
        ...
        return self._set_configs_private(
            configs.serialize(), timeout_seconds, future_proof_configs, False
        )
    ...
    def set_position(
        ...
        Native.instance().c_ctre_phoenix6_serialize_double(
            SpnValue.TALON_FX_SET_SENSOR_POSITION.value, new_value, ctypes.byref(value)
        )
    ...
    def clear_sticky_faults(self, timeout_seconds: second = 0.050) -> StatusCode:
        ...
        value = ctypes.c_char_p()
        Native.instance().c_ctre_phoenix6_serialize_double(
            SpnValue.SPN_CLEAR_STICKY_FAULTS.value, 0, ctypes.byref(value)
        )
        if value.value is not None:
            serialized = str(value.value, encoding="utf-8")
            Native.instance().c_ctre_phoenix6_free_memory(ctypes.byref(value))
    ...
    def clear_sticky_fault_hardware(
        ...
        value = ctypes.c_char_p()
        Native.instance().c_ctre_phoenix6_serialize_double(
            SpnValue.CLEAR_STICKY_FAULT_HARDWARE.value, 0, ctypes.byref(value)
        )
        if value.value is not None:
            serialized = str(value.value, encoding="utf-8")
            Native.instance().c_ctre_phoenix6_free_memory(ctypes.byref(value))
    ...
    def clear_sticky_fault_proc_temp(
        ...
        value = ctypes.c_char_p()
        Native.instance().c_ctre_phoenix6_serialize_double(
            SpnValue.CLEAR_STICKY_FAULT_PROC_TEMP.value, 0, ctypes.byref(value)
        )
        if value.value is not None:
            serialized = str(value.value, encoding="utf-8")
            Native.instance().c_ctre_phoenix6_free_memory(ctypes.byref(value))
    ...
    def clear_sticky_fault_device_temp(
        ...
        value = ctypes.c_char_p()
        Native.instance().c_ctre_phoenix6_serialize_double(
            SpnValue.CLEAR_STICKY_FAULT_DEVICE_TEMP.value, 0, ctypes.byref(value)
        )
        if value.value is not None:
            serialized = str(value.value, encoding="utf-8")
            Native.instance().c_ctre_phoenix6_free_memory(ctypes.byref(value))
    ...
    def clear_sticky_fault_undervoltage(
        ...
        value = ctypes.c_char_p()
        Native.instance().c_ctre_phoenix6_serialize_double(
            SpnValue.CLEAR_STICKY_FAULT_UNDERVOLTAGE.value, 0, ctypes.byref(value)
        )
        if value.value is not None:
            serialized = str(value.value, encoding="utf-8")
            Native.instance().c_ctre_phoenix6_free_memory(ctypes.byref(value))
    ...
    def clear_sticky_fault_boot_during_enable(
        ...
        value = ctypes.c_char_p()
        Native.instance().c_ctre_phoenix6_serialize_double(
            SpnValue.CLEAR_STICKY_FAULT_BOOT_DURING_ENABLE.value, 0, ctypes.byref(value)
        )
        if value.value is not None:
            serialized = str(value.value, encoding="utf-8")
            Native.instance().c_ctre_phoenix6_free_memory(ctypes.byref(value))
    ...
    def clear_sticky_fault_bridge_brownout(
        ...
        value = ctypes.c_char_p()
        Native.instance().c_ctre_phoenix6_serialize_double(
            SpnValue.CLEAR_STICKY_FAULT_TALONFX_BRIDGE_BROWNOUT.value,
            0,
            ctypes.byref(value),
        )
        if value.value is not None:
    ...
    def clear_sticky_fault_remote_sensor_reset(
        ...
        value = ctypes.c_char_p()
        Native.instance().c_ctre_phoenix6_serialize_double(
            SpnValue.CLEAR_STICKY_FAULT_TALONFX_REMOTE_SENSOR_RESET.value,
            0,
            ctypes.byref(value),
        )
        if value.value is not None:
    ...
    def clear_sticky_fault_missing_differential_fx(
        ...
        value = ctypes.c_char_p()
        Native.instance().c_ctre_phoenix6_serialize_double(
            SpnValue.CLEAR_STICKY_FAULT_TALONFX_MISSING_DIFFERENTIAL_FX.value,
            0,
            ctypes.byref(value),
        )
        if value.value is not None:
    ...
    def clear_sticky_fault_remote_sensor_pos_overflow(
        ...
        value = ctypes.c_char_p()
        Native.instance().c_ctre_phoenix6_serialize_double(
            SpnValue.CLEAR_STICKY_FAULT_TALONFX_REMOTE_SENSOR_POS_OVERFLOW.value,
            0,
            ctypes.byref(value),
        )
        if value.value is not None:
    ...
    def clear_sticky_fault_over_supply_v(
        ...
        value = ctypes.c_char_p()
        Native.instance().c_ctre_phoenix6_serialize_double(
            SpnValue.CLEAR_STICKY_FAULT_TALONFX_OVER_SUPPLYV.value,
            0,
            ctypes.byref(value),
        )
        if value.value is not None:
    ...
    def clear_sticky_fault_unstable_supply_v(
        ...
        value = ctypes.c_char_p()
        Native.instance().c_ctre_phoenix6_serialize_double(
            SpnValue.CLEAR_STICKY_FAULT_TALONFX_UNSTABLE_SUPPLYV.value,
            0,
            ctypes.byref(value),
        )
        if value.value is not None:
    ...
    def clear_sticky_fault_reverse_hard_limit(
        ...
        value = ctypes.c_char_p()
        Native.instance().c_ctre_phoenix6_serialize_double(
            SpnValue.CLEAR_STICKY_FAULT_TALONFX_REVERSE_HARD_LIMIT.value,
            0,
            ctypes.byref(value),
        )
        if value.value is not None:
    ...
    def clear_sticky_fault_forward_hard_limit(
        ...
        value = ctypes.c_char_p()
        Native.instance().c_ctre_phoenix6_serialize_double(
            SpnValue.CLEAR_STICKY_FAULT_TALONFX_FORWARD_HARD_LIMIT.value,
            0,
            ctypes.byref(value),
        )
        if value.value is not None:
    ...
    def clear_sticky_fault_reverse_soft_limit(
        ...
        value = ctypes.c_char_p()
        Native.instance().c_ctre_phoenix6_serialize_double(
            SpnValue.CLEAR_STICKY_FAULT_TALONFX_REVERSE_SOFT_LIMIT.value,
            0,
            ctypes.byref(value),
        )
        if value.value is not None:
    ...
    def clear_sticky_fault_forward_soft_limit(
        ...
        value = ctypes.c_char_p()
        Native.instance().c_ctre_phoenix6_serialize_double(
            SpnValue.CLEAR_STICKY_FAULT_TALONFX_FORWARD_SOFT_LIMIT.value,
            0,
            ctypes.byref(value),
        )
        if value.value is not None:
    ...
    def clear_sticky_fault_remote_sensor_data_invalid(
        ...
        value = ctypes.c_char_p()
        Native.instance().c_ctre_phoenix6_serialize_double(
            SpnValue.CLEAR_STICKY_FAULT_TALONFX_MISSING_REMOTE_SENSOR.value,
            0,
            ctypes.byref(value),
        )
        if value.value is not None:
    ...
    def clear_sticky_fault_fused_sensor_out_of_sync(
        ...
        value = ctypes.c_char_p()
        Native.instance().c_ctre_phoenix6_serialize_double(
            SpnValue.CLEAR_STICKY_FAULT_TALONFX_FUSED_SENSOR_OUT_OF_SYNC.value,
            0,
            ctypes.byref(value),
        )
        if value.value is not None:
    ...
    def clear_sticky_fault_stator_curr_limit(
        ...
        value = ctypes.c_char_p()
        Native.instance().c_ctre_phoenix6_serialize_double(
            SpnValue.CLEAR_STICKY_FAULT_TALONFX_STATOR_CURR_LIMIT.value,
            0,
            ctypes.byref(value),
        )
        if value.value is not None:
    ...
    def clear_sticky_fault_supply_curr_limit(
        ...
        value = ctypes.c_char_p()
        Native.instance().c_ctre_phoenix6_serialize_double(
            SpnValue.CLEAR_STICKY_FAULT_TALONFX_SUPPLY_CURR_LIMIT.value,
            0,
            ctypes.byref(value),
        )
        if value.value is not None:
