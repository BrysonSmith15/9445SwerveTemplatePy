...
class Orchestra:
    ...
    def add_instrument(self, instrument: ParentDevice) -> StatusCode:
        ...
        return StatusCode(
            Native.instance().c_ctre_phoenix6_orchestra_AddDevice(
                self.__id, c_network, instrument.device_hash
            )
        )

    def add_instrument_with_track(
        self, instrument: ParentDevice, track_number: int
    ) -> StatusCode:
        """
        ...
        c_network = ctypes.c_char_p(bytes(instrument.network, "utf-8"))
        return StatusCode(
            Native.instance().c_ctre_phoenix6_orchestra_AddDeviceWithTrack(
                self.__id, c_network, instrument.device_hash, track_number
            )
        )
    ...
    def clear_instruments(self) -> StatusCode:
        ...
        """
        return StatusCode(
            Native.instance().c_ctre_phoenix6_orchestra_ClearDevices(self.__id)
        )
    ...
    def load_music(self, filepath: str) -> StatusCode:
        ...
        return StatusCode(
            Native.instance().c_ctre_phoenix6_orchestra_LoadMusic(self.__id, c_filepath)
        )
    ...
    def is_playing(self) -> bool:
        ...
        Native.instance().c_ctre_phoenix6_orchestra_IsPlaying(
            self.__id, ctypes.byref(is_playing)
        )
    ...
    def get_current_time(self) -> second:
        ...
        Native.instance().c_ctre_phoenix6_orchestra_GetCurrentTime(
            self.__id, ctypes.byref(time_seconds)
        )
