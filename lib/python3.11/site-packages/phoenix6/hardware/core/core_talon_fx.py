...
from phoenix6.controls.motion_magic_torque_current_foc import (
...
from phoenix6.controls.motion_magic_velocity_duty_cycle import (
    MotionMagicVelocityDutyCycle,
)
from phoenix6.controls.motion_magic_velocity_torque_current_foc import (
...
from phoenix6.controls.motion_magic_expo_torque_current_foc import (
    MotionMagicExpoTorqueCurrentFOC,
)
from phoenix6.controls.dynamic_motion_magic_duty_cycle import (
    DynamicMotionMagicDutyCycle,
)
from phoenix6.controls.dynamic_motion_magic_voltage import DynamicMotionMagicVoltage
from phoenix6.controls.dynamic_motion_magic_torque_current_foc import (
...
class CoreTalonFX(ParentDevice):
    ...
    def __init__(self, device_id: int, canbus: str = ""):
        ...
        Native.instance().c_ctre_phoenix6_platform_sim_create(
            DeviceType.PRO_TalonFXType.value, device_id
        )
    ...
    def _get_pid_duty_cycle_proportional_output(self) -> StatusSignal[float]:
        ...
        return self._common_lookup(
            ...
            0,
            None,
            "pid_duty_cycle_proportional_output",
            True,
            float,
        )
    ...
    def _get_pid_motor_voltage_proportional_output(self) -> StatusSignal[volt]:
        ...
        return self._common_lookup(
            ...
            0,
            None,
            "pid_motor_voltage_proportional_output",
            True,
            volt,
        )
    ...
    def _get_pid_torque_current_proportional_output(self) -> StatusSignal[ampere]:
        ...
        return self._common_lookup(
            ...
            0,
            None,
            "pid_torque_current_proportional_output",
            True,
            ampere,
        )
    ...
    def _get_pid_duty_cycle_integrated_accum(self) -> StatusSignal[float]:
        ...
        return self._common_lookup(
            ...
            0,
            None,
            "pid_duty_cycle_integrated_accum",
            True,
            float,
        )
    ...
    def _get_pid_motor_voltage_integrated_accum(self) -> StatusSignal[volt]:
        ...
        return self._common_lookup(
            ...
            0,
            None,
            "pid_motor_voltage_integrated_accum",
            True,
            volt,
        )
    ...
    def _get_pid_torque_current_integrated_accum(self) -> StatusSignal[ampere]:
        ...
        return self._common_lookup(
            ...
            0,
            None,
            "pid_torque_current_integrated_accum",
            True,
            ampere,
        )
    ...
    def _get_pid_motor_voltage_feed_forward(self) -> StatusSignal[volt]:
        ...
        return self._common_lookup(
            ...
            0,
            None,
            "pid_motor_voltage_feed_forward",
            True,
            volt,
        )
    ...
    def _get_pid_torque_current_feed_forward(self) -> StatusSignal[ampere]:
        ...
        return self._common_lookup(
            ...
            0,
            None,
            "pid_torque_current_feed_forward",
            True,
            ampere,
        )
    ...
    def _get_pid_duty_cycle_derivative_output(self) -> StatusSignal[float]:
        ...
        return self._common_lookup(
            ...
            0,
            None,
            "pid_duty_cycle_derivative_output",
            True,
            float,
        )
    ...
    def _get_pid_motor_voltage_derivative_output(self) -> StatusSignal[volt]:
        ...
        return self._common_lookup(
            ...
            0,
            None,
            "pid_motor_voltage_derivative_output",
            True,
            volt,
        )
    ...
    def _get_pid_torque_current_derivative_output(self) -> StatusSignal[ampere]:
        ...
        return self._common_lookup(
            ...
            0,
            None,
            "pid_torque_current_derivative_output",
            True,
            ampere,
        )
    ...
    def _get_pid_position_reference_slope(self) -> StatusSignal[rotations_per_second]:
        ...
        return self._common_lookup(
            ...
            0,
            None,
            "pid_position_reference_slope",
            True,
            rotations_per_second,
        )

    def _get_pid_velocity_reference_slope(
        self,
    ...
    def _get_pid_position_closed_loop_error(self) -> StatusSignal[rotation]:
        ...
        return self._common_lookup(
            ...
            0,
            None,
            "pid_position_closed_loop_error",
            True,
            rotation,
        )
    ...
    def _get_pid_velocity_closed_loop_error(self) -> StatusSignal[rotations_per_second]:
        ...
        return self._common_lookup(
            ...
            0,
            None,
            "pid_velocity_closed_loop_error",
            True,
            rotations_per_second,
        )
    ...
    def _get_differential_torque_current(self) -> StatusSignal[ampere]:
        ...
        return self._common_lookup(
            ...
            0,
            None,
            "differential_torque_current",
            True,
            ampere,
        )

    def _get_differential_pid_duty_cycle_proportional_output(
        self,
    ) -> StatusSignal[float]:
        """
        ...
        return self._common_lookup(
            ...
            0,
            None,
            "differential_pid_duty_cycle_proportional_output",
            True,
            float,
        )

    def _get_differential_pid_motor_voltage_proportional_output(
        self,
    ) -> StatusSignal[volt]:
        """
        Proportional output of differential PID controller when PID'ing under
        ...
        return self._common_lookup(
            ...
            0,
            None,
            "differential_pid_motor_voltage_proportional_output",
            True,
            volt,
        )

    def _get_differential_pid_torque_current_proportional_output(
        self,
    ) -> StatusSignal[ampere]:
        """
        Proportional output of differential PID controller when PID'ing under
        ...
        return self._common_lookup(
            ...
            0,
            None,
            "differential_pid_torque_current_proportional_output",
            True,
            ampere,
        )
    ...
    def _get_differential_pid_duty_cycle_integrated_accum(self) -> StatusSignal[float]:
        ...
        return self._common_lookup(
            ...
            0,
            None,
            "differential_pid_duty_cycle_integrated_accum",
            True,
            float,
        )

    def _get_differential_pid_motor_voltage_integrated_accum(
        self,
    ) -> StatusSignal[volt]:
        """
        Integrated Accumulator of differential PID controller when PID'ing
        ...
        return self._common_lookup(
            ...
            0,
            None,
            "differential_pid_motor_voltage_integrated_accum",
            True,
            volt,
        )

    def _get_differential_pid_torque_current_integrated_accum(
        self,
    ) -> StatusSignal[ampere]:
        """
        Integrated Accumulator of differential PID controller when PID'ing
        ...
        return self._common_lookup(
            ...
            0,
            None,
            "differential_pid_torque_current_integrated_accum",
            True,
            ampere,
        )
    ...
    def _get_differential_pid_duty_cycle_feed_forward(self) -> StatusSignal[float]:
        ...
        return self._common_lookup(
            ...
            0,
            None,
            "differential_pid_duty_cycle_feed_forward",
            True,
            float,
        )
    ...
    def _get_differential_pid_motor_voltage_feed_forward(self) -> StatusSignal[volt]:
        ...
        return self._common_lookup(
            ...
            0,
            None,
            "differential_pid_motor_voltage_feed_forward",
            True,
            volt,
        )
    ...
    def _get_differential_pid_torque_current_feed_forward(self) -> StatusSignal[ampere]:
        ...
        return self._common_lookup(
            ...
            0,
            None,
            "differential_pid_torque_current_feed_forward",
            True,
            ampere,
        )
    ...
    def _get_differential_pid_duty_cycle_derivative_output(self) -> StatusSignal[float]:
        ...
        return self._common_lookup(
            ...
            0,
            None,
            "differential_pid_duty_cycle_derivative_output",
            True,
            float,
        )
    ...
    def _get_diff_pid_motor_voltage_derivative_output(self) -> StatusSignal[volt]:
        ...
        return self._common_lookup(
            ...
            0,
            None,
            "diff_pid_motor_voltage_derivative_output",
            True,
            volt,
        )

    def _get_differential_pid_torque_current_derivative_output(
        self,
    ) -> StatusSignal[ampere]:
        """
        Derivative Output of differential PID controller when PID'ing under a
        ...
        return self._common_lookup(
            ...
            0,
            None,
            "differential_pid_torque_current_derivative_output",
            True,
            ampere,
        )
    ...
    def _get_differential_pid_duty_cycle_output(self) -> StatusSignal[float]:
        ...
        return self._common_lookup(
            ...
            0,
            None,
            "differential_pid_duty_cycle_output",
            True,
            float,
        )
    ...
    def _get_differential_pid_motor_voltage_output(self) -> StatusSignal[volt]:
        ...
        return self._common_lookup(
            ...
            0,
            None,
            "differential_pid_motor_voltage_output",
            True,
            volt,
        )
    ...
    def _get_differential_pid_torque_current_output(self) -> StatusSignal[ampere]:
        ...
        return self._common_lookup(
            ...
            0,
            None,
            "differential_pid_torque_current_output",
            True,
            ampere,
        )
    ...
    def _get_differential_pid_position_reference(self) -> StatusSignal[rotation]:
        ...
        return self._common_lookup(
            ...
            0,
            None,
            "differential_pid_position_reference",
            True,
            rotation,
        )

    def _get_differential_pid_velocity_reference(
        self,
        ...
        return self._common_lookup(
            ...
            0,
            None,
            "differential_pid_velocity_reference",
            True,
            rotations_per_second,
        )

    def _get_differential_pid_position_reference_slope(
        self,
    ) -> StatusSignal[rotations_per_second]:
        """
        ...
        return self._common_lookup(
            ...
            0,
            None,
            "differential_pid_position_reference_slope",
            True,
            rotations_per_second,
        )

    def _get_differential_pid_velocity_reference_slope(
        self,
    ) -> StatusSignal[rotations_per_second_squared]:
        """
        ...
        return self._common_lookup(
            ...
            0,
            None,
            "differential_pid_velocity_reference_slope",
            True,
            rotations_per_second_squared,
        )

    def _get_differential_pid_position_closed_loop_error(
        self,
        ...
        return self._common_lookup(
            ...
            0,
            None,
            "differential_pid_position_closed_loop_error",
            True,
            rotation,
        )

    def _get_differential_pid_velocity_closed_loop_error(
        self,
    ) -> StatusSignal[rotations_per_second]:
        """
        ...
        return self._common_lookup(
            ...
            0,
            None,
            "differential_pid_velocity_closed_loop_error",
            True,
            rotations_per_second,
        )
    ...
    def get_version_major(self) -> StatusSignal[int]:
        ...
        """
        return self._common_lookup(
            SpnValue.VERSION_MAJOR.value, 0, None, "version_major", False, int
        )
    ...
    def get_version_minor(self) -> StatusSignal[int]:
        ...
        """
        return self._common_lookup(
            SpnValue.VERSION_MINOR.value, 0, None, "version_minor", False, int
        )
    ...
    def get_version_bugfix(self) -> StatusSignal[int]:
        ...
        """
        return self._common_lookup(
            SpnValue.VERSION_BUGFIX.value, 0, None, "version_bugfix", False, int
        )
    ...
    def get_version_build(self) -> StatusSignal[int]:
        ...
        """
        return self._common_lookup(
            SpnValue.VERSION_BUILD.value, 0, None, "version_build", False, int
        )
    ...
    def get_version(self) -> StatusSignal[int]:
        ...
        """
        return self._common_lookup(
            SpnValue.VERSION_FULL.value, 0, None, "version", False, int
        )
    ...
    def get_fault_field(self) -> StatusSignal[int]:
        ...
        """
        return self._common_lookup(
            SpnValue.ALL_FAULTS.value, 0, None, "fault_field", True, int
        )
    ...
    def get_sticky_fault_field(self) -> StatusSignal[int]:
        ...
        """
        return self._common_lookup(
            SpnValue.ALL_STICKY_FAULTS.value, 0, None, "sticky_fault_field", True, int
        )
    ...
    def get_motor_voltage(self) -> StatusSignal[volt]:
        ...
        """
        return self._common_lookup(
            SpnValue.PRO_MOTOR_OUTPUT_MOTOR_VOLTAGE.value,
            0,
            None,
            "motor_voltage",
            True,
    ...
    def get_applied_rotor_polarity(self) -> StatusSignal[AppliedRotorPolarityValue]:
        ...
        """
        return self._common_lookup(
            SpnValue.PRO_MOTOR_OUTPUT_ROTOR_POLARITY.value,
            0,
            None,
            "applied_rotor_polarity",
            True,
            AppliedRotorPolarityValue,
        )
    ...
    def get_duty_cycle(self) -> StatusSignal[float]:
        ...
        """
        return self._common_lookup(
            SpnValue.PRO_MOTOR_OUTPUT_DUTY_CYCLE.value,
            0,
            None,
            "duty_cycle",
            True,
    ...
    def get_torque_current(self) -> StatusSignal[ampere]:
        ...
        """
        return self._common_lookup(
            SpnValue.PRO_MOTOR_OUTPUT_TORQUE_CURRENT.value,
            0,
            None,
            "torque_current",
            True,
    ...
    def get_stator_current(self) -> StatusSignal[ampere]:
        ...
        """
        return self._common_lookup(
            SpnValue.PRO_SUPPLY_AND_TEMP_STATOR_CURRENT.value,
            0,
            None,
            "stator_current",
            True,
    ...
    def get_supply_current(self) -> StatusSignal[ampere]:
        ...
        """
        return self._common_lookup(
            SpnValue.PRO_SUPPLY_AND_TEMP_SUPPLY_CURRENT.value,
            0,
            None,
            "supply_current",
            True,
    ...
    def get_supply_voltage(self) -> StatusSignal[volt]:
        ...
        """
        return self._common_lookup(
            SpnValue.PRO_SUPPLY_AND_TEMP_SUPPLY_VOLTAGE.value,
            0,
            None,
            "supply_voltage",
            True,
    ...
    def get_device_temp(self) -> StatusSignal[celsius]:
        ...
        """
        return self._common_lookup(
            SpnValue.PRO_SUPPLY_AND_TEMP_DEVICE_TEMP.value,
            0,
            None,
            "device_temp",
            True,
    ...
    def get_processor_temp(self) -> StatusSignal[celsius]:
        ...
        """
        return self._common_lookup(
            SpnValue.PRO_SUPPLY_AND_TEMP_PROCESSOR_TEMP.value,
            0,
            None,
            "processor_temp",
            True,
    ...
    def get_rotor_velocity(self) -> StatusSignal[rotations_per_second]:
        ...
        """
        return self._common_lookup(
            SpnValue.PRO_ROTOR_POS_AND_VEL_VELOCITY.value,
            0,
            None,
            "rotor_velocity",
            True,
    ...
    def get_rotor_position(self) -> StatusSignal[rotation]:
        ...
        """
        return self._common_lookup(
            SpnValue.PRO_ROTOR_POS_AND_VEL_POSITION.value,
            0,
            None,
            "rotor_position",
            True,
    ...
    def get_velocity(self) -> StatusSignal[rotations_per_second]:
        ...
        """
        return self._common_lookup(
            SpnValue.PRO_POS_AND_VEL_VELOCITY.value,
            0,
            None,
            "velocity",
            True,
    ...
    def get_position(self) -> StatusSignal[rotation]:
        ...
        """
        return self._common_lookup(
            SpnValue.PRO_POS_AND_VEL_POSITION.value, 0, None, "position", True, rotation
        )
    ...
    def get_acceleration(self) -> StatusSignal[rotations_per_second_squared]:
        ...
        """
        return self._common_lookup(
            SpnValue.PRO_POS_AND_VEL_ACCELERATION.value,
            0,
            None,
            "acceleration",
            True,
    ...
    def get_control_mode(self) -> StatusSignal[ControlModeValue]:
        ...
        """
        return self._common_lookup(
            SpnValue.TALON_FX_CONTROL_MODE.value,
            0,
            None,
            "control_mode",
            True,
    ...
    def get_motion_magic_is_running(self) -> StatusSignal[MotionMagicIsRunningValue]:
        ...
        """
        return self._common_lookup(
            SpnValue.PRO_PIDSTATE_ENABLES_IS_MOTION_MAGIC_RUNNING.value,
            0,
            None,
            "motion_magic_is_running",
            True,
            MotionMagicIsRunningValue,
        )
    ...
    def get_device_enable(self) -> StatusSignal[DeviceEnableValue]:
        ...
        """
        return self._common_lookup(
            SpnValue.PRO_PIDSTATE_ENABLES_DEVICE_ENABLE.value,
            0,
            None,
            "device_enable",
            True,
    ...
    def get_closed_loop_slot(self) -> StatusSignal[int]:
        ...
        """
        return self._common_lookup(
            SpnValue.PRO_PIDOUTPUT_SLOT.value, 0, None, "closed_loop_slot", True, int
        )

    def get_differential_control_mode(
        self,
        ...
        """
        return self._common_lookup(
            SpnValue.TALON_FX_DIFFERENTIAL_CONTROL_MODE.value,
            0,
            None,
            "differential_control_mode",
            True,
            DifferentialControlModeValue,
        )
    ...
    def get_differential_average_velocity(self) -> StatusSignal[rotations_per_second]:
        ...
        """
        return self._common_lookup(
            SpnValue.PRO_AVG_POS_AND_VEL_VELOCITY.value,
            0,
            None,
            "differential_average_velocity",
            True,
            rotations_per_second,
        )
    ...
    def get_differential_average_position(self) -> StatusSignal[rotation]:
        ...
        """
        return self._common_lookup(
            SpnValue.PRO_AVG_POS_AND_VEL_POSITION.value,
            0,
            None,
            "differential_average_position",
            True,
            rotation,
        )

    def get_differential_difference_velocity(
        self,
    ) -> StatusSignal[rotations_per_second]:
        """
        ...
        """
        return self._common_lookup(
            SpnValue.PRO_DIFF_POS_AND_VEL_VELOCITY.value,
            0,
            None,
            "differential_difference_velocity",
            True,
            rotations_per_second,
        )
    ...
    def get_differential_difference_position(self) -> StatusSignal[rotation]:
        ...
        """
        return self._common_lookup(
            SpnValue.PRO_DIFF_POS_AND_VEL_POSITION.value,
            0,
            None,
            "differential_difference_position",
            True,
            rotation,
        )
    ...
    def get_differential_closed_loop_slot(self) -> StatusSignal[int]:
        ...
        """
        return self._common_lookup(
            SpnValue.PRO_DIFF_PIDOUTPUT_SLOT.value,
            0,
            None,
            "differential_closed_loop_slot",
            True,
            int,
        )
    ...
    def get_bridge_output(self) -> StatusSignal[BridgeOutputValue]:
        ...
        """
        return self._common_lookup(
            SpnValue.PRO_MOTOR_OUTPUT_BRIDGE_TYPE_PUBLIC.value,
            0,
            None,
            "bridge_output",
            True,
    ...
    def get_is_pro_licensed(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.VERSION_IS_PRO_LICENSED.value,
            0,
            None,
            "is_pro_licensed",
            True,
    ...
    def get_ancillary_device_temp(self) -> StatusSignal[celsius]:
        ...
        """
        return self._common_lookup(
            SpnValue.PRO_SUPPLY_AND_TEMP_DEVICE_TEMP2.value,
            0,
            None,
            "ancillary_device_temp",
            True,
            celsius,
        )
    ...
    def get_motor_type(self) -> StatusSignal[MotorTypeValue]:
        ...
        """
        return self._common_lookup(
            SpnValue.TALON_FX_MOTOR_TYPE.value,
            0,
            None,
            "motor_type",
            True,
    ...
    def get_motor_output_status(self) -> StatusSignal[MotorOutputStatusValue]:
        ...
        """
        return self._common_lookup(
            SpnValue.TALON_FX_MOTOR_OUTPUT_STATUS.value,
            0,
            None,
            "motor_output_status",
            True,
    ...
    def get_fault_hardware(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.FAULT_HARDWARE.value, 0, None, "fault_hardware", True, bool
        )
    ...
    def get_sticky_fault_hardware(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.STICKY_FAULT_HARDWARE.value,
            0,
            None,
    ...
    def get_fault_proc_temp(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.FAULT_PROC_TEMP.value, 0, None, "fault_proc_temp", True, bool
        )
    ...
    def get_sticky_fault_proc_temp(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.STICKY_FAULT_PROC_TEMP.value,
            0,
            None,
            "sticky_fault_proc_temp",
            True,
            bool,
        )
    ...
    def get_fault_device_temp(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.FAULT_DEVICE_TEMP.value, 0, None, "fault_device_temp", True, bool
        )
    ...
    def get_sticky_fault_device_temp(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.STICKY_FAULT_DEVICE_TEMP.value,
            0,
            None,
            "sticky_fault_device_temp",
            True,
            bool,
        )
    ...
    def get_fault_undervoltage(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.FAULT_UNDERVOLTAGE.value, 0, None, "fault_undervoltage", True, bool
        )
    ...
    def get_sticky_fault_undervoltage(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.STICKY_FAULT_UNDERVOLTAGE.value,
            0,
            None,
            "sticky_fault_undervoltage",
            True,
            bool,
        )
    ...
    def get_fault_boot_during_enable(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.FAULT_BOOT_DURING_ENABLE.value,
            0,
            None,
    ...
    def get_sticky_fault_boot_during_enable(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.STICKY_FAULT_BOOT_DURING_ENABLE.value,
            0,
            None,
    ...
    def get_fault_unlicensed_feature_in_use(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.FAULT_UNLICENSED_FEATURE_IN_USE.value,
            0,
            None,
            "fault_unlicensed_feature_in_use",
            True,
            bool,
        )
    ...
    def get_sticky_fault_unlicensed_feature_in_use(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.STICKY_FAULT_UNLICENSED_FEATURE_IN_USE.value,
            0,
            None,
            "sticky_fault_unlicensed_feature_in_use",
            True,
            bool,
        )
    ...
    def get_fault_bridge_brownout(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.FAULT_TALONFX_BRIDGE_BROWNOUT.value,
            0,
            None,
            "fault_bridge_brownout",
            True,
            bool,
        )
    ...
    def get_sticky_fault_bridge_brownout(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.STICKY_FAULT_TALONFX_BRIDGE_BROWNOUT.value,
            0,
            None,
            "sticky_fault_bridge_brownout",
            True,
            bool,
        )
    ...
    def get_fault_remote_sensor_reset(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.FAULT_TALONFX_REMOTE_SENSOR_RESET.value,
            0,
            None,
            "fault_remote_sensor_reset",
            True,
            bool,
        )
    ...
    def get_sticky_fault_remote_sensor_reset(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.STICKY_FAULT_TALONFX_REMOTE_SENSOR_RESET.value,
            0,
            None,
            "sticky_fault_remote_sensor_reset",
            True,
            bool,
        )
    ...
    def get_fault_missing_differential_fx(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.FAULT_TALONFX_MISSING_DIFFERENTIAL_FX.value,
            0,
            None,
            "fault_missing_differential_fx",
            True,
            bool,
        )
    ...
    def get_sticky_fault_missing_differential_fx(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.STICKY_FAULT_TALONFX_MISSING_DIFFERENTIAL_FX.value,
            0,
            None,
            "sticky_fault_missing_differential_fx",
            True,
            bool,
        )
    ...
    def get_fault_remote_sensor_pos_overflow(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.FAULT_TALONFX_REMOTE_SENSOR_POS_OVERFLOW.value,
            0,
            None,
            "fault_remote_sensor_pos_overflow",
            True,
            bool,
        )
    ...
    def get_sticky_fault_remote_sensor_pos_overflow(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.STICKY_FAULT_TALONFX_REMOTE_SENSOR_POS_OVERFLOW.value,
            0,
            None,
            "sticky_fault_remote_sensor_pos_overflow",
            True,
            bool,
        )
    ...
    def get_fault_over_supply_v(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.FAULT_TALONFX_OVER_SUPPLYV.value,
            0,
            None,
            "fault_over_supply_v",
            True,
    ...
    def get_sticky_fault_over_supply_v(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.STICKY_FAULT_TALONFX_OVER_SUPPLYV.value,
            0,
            None,
            "sticky_fault_over_supply_v",
            True,
            bool,
        )
    ...
    def get_fault_unstable_supply_v(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.FAULT_TALONFX_UNSTABLE_SUPPLYV.value,
            0,
            None,
            "fault_unstable_supply_v",
            True,
            bool,
        )
    ...
    def get_sticky_fault_unstable_supply_v(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.STICKY_FAULT_TALONFX_UNSTABLE_SUPPLYV.value,
            0,
            None,
            "sticky_fault_unstable_supply_v",
            True,
            bool,
        )
    ...
    def get_fault_reverse_hard_limit(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.FAULT_TALONFX_REVERSE_HARD_LIMIT.value,
            0,
            None,
            "fault_reverse_hard_limit",
            True,
            bool,
        )
    ...
    def get_sticky_fault_reverse_hard_limit(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.STICKY_FAULT_TALONFX_REVERSE_HARD_LIMIT.value,
            0,
            None,
            "sticky_fault_reverse_hard_limit",
            True,
            bool,
        )
    ...
    def get_fault_forward_hard_limit(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.FAULT_TALONFX_FORWARD_HARD_LIMIT.value,
            0,
            None,
            "fault_forward_hard_limit",
            True,
            bool,
        )
    ...
    def get_sticky_fault_forward_hard_limit(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.STICKY_FAULT_TALONFX_FORWARD_HARD_LIMIT.value,
            0,
            None,
            "sticky_fault_forward_hard_limit",
            True,
            bool,
        )
    ...
    def get_fault_reverse_soft_limit(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.FAULT_TALONFX_REVERSE_SOFT_LIMIT.value,
            0,
            None,
            "fault_reverse_soft_limit",
            True,
            bool,
        )
    ...
    def get_sticky_fault_reverse_soft_limit(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.STICKY_FAULT_TALONFX_REVERSE_SOFT_LIMIT.value,
            0,
            None,
            "sticky_fault_reverse_soft_limit",
            True,
            bool,
        )
    ...
    def get_fault_forward_soft_limit(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.FAULT_TALONFX_FORWARD_SOFT_LIMIT.value,
            0,
            None,
            "fault_forward_soft_limit",
            True,
            bool,
        )
    ...
    def get_sticky_fault_forward_soft_limit(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.STICKY_FAULT_TALONFX_FORWARD_SOFT_LIMIT.value,
            0,
            None,
            "sticky_fault_forward_soft_limit",
            True,
            bool,
        )
    ...
    def get_fault_remote_sensor_data_invalid(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.FAULT_TALONFX_MISSING_REMOTE_SENSOR.value,
            0,
            None,
            "fault_remote_sensor_data_invalid",
            True,
            bool,
        )
    ...
    def get_sticky_fault_remote_sensor_data_invalid(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.STICKY_FAULT_TALONFX_MISSING_REMOTE_SENSOR.value,
            0,
            None,
            "sticky_fault_remote_sensor_data_invalid",
            True,
            bool,
        )
    ...
    def get_fault_fused_sensor_out_of_sync(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.FAULT_TALONFX_FUSED_SENSOR_OUT_OF_SYNC.value,
            0,
            None,
            "fault_fused_sensor_out_of_sync",
            True,
            bool,
        )
    ...
    def get_sticky_fault_fused_sensor_out_of_sync(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.STICKY_FAULT_TALONFX_FUSED_SENSOR_OUT_OF_SYNC.value,
            0,
            None,
            "sticky_fault_fused_sensor_out_of_sync",
            True,
            bool,
        )
    ...
    def get_fault_stator_curr_limit(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.FAULT_TALONFX_STATOR_CURR_LIMIT.value,
            0,
            None,
            "fault_stator_curr_limit",
            True,
            bool,
        )
    ...
    def get_sticky_fault_stator_curr_limit(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.STICKY_FAULT_TALONFX_STATOR_CURR_LIMIT.value,
            0,
            None,
            "sticky_fault_stator_curr_limit",
            True,
            bool,
        )
    ...
    def get_fault_supply_curr_limit(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.FAULT_TALONFX_SUPPLY_CURR_LIMIT.value,
            0,
            None,
            "fault_supply_curr_limit",
            True,
            bool,
        )
    ...
    def get_sticky_fault_supply_curr_limit(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.STICKY_FAULT_TALONFX_SUPPLY_CURR_LIMIT.value,
            0,
            None,
            "sticky_fault_supply_curr_limit",
            True,
            bool,
        )
    ...
    def get_fault_using_fused_ca_ncoder_while_unlicensed(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.FAULT_TALONFX_USING_FUSED_CCWHILE_UNLICENSED.value,
            0,
            None,
            "fault_using_fused_ca_ncoder_while_unlicensed",
            True,
            bool,
        )

    def get_sticky_fault_using_fused_ca_ncoder_while_unlicensed(
        self,
    ) -> StatusSignal[bool]:
        """
        Using Fused CANcoder feature while unlicensed. Device has fallen back
        ...
        """
        return self._common_lookup(
            SpnValue.STICKY_FAULT_TALONFX_USING_FUSED_CCWHILE_UNLICENSED.value,
            0,
            None,
            "sticky_fault_using_fused_ca_ncoder_while_unlicensed",
            True,
            bool,
        )
    ...
    def get_fault_static_brake_disabled(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.FAULT_TALONFX_STATIC_BRAKE_DISABLED.value,
            0,
            None,
            "fault_static_brake_disabled",
            True,
            bool,
        )
    ...
    def get_sticky_fault_static_brake_disabled(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.STICKY_FAULT_TALONFX_STATIC_BRAKE_DISABLED.value,
            0,
            None,
            "sticky_fault_static_brake_disabled",
            True,
            bool,
        )
    ...
    def get_closed_loop_proportional_output(self) -> StatusSignal[float]:
        ...
        return self._common_lookup(
            ...
            1,
            map_filler,
            "closed_loop_proportional_output",
            True,
            float,
        )
    ...
    def get_differential_closed_loop_proportional_output(self) -> StatusSignal[float]:
        ...
        return self._common_lookup(
            ...
            10,
            map_filler,
            "differential_closed_loop_proportional_output",
            True,
            float,
        )
    ...
    def get_differential_closed_loop_integrated_output(self) -> StatusSignal[float]:
        ...
        return self._common_lookup(
            ...
            11,
            map_filler,
            "differential_closed_loop_integrated_output",
            True,
            float,
        )
    ...
    def get_differential_closed_loop_feed_forward(self) -> StatusSignal[float]:
        ...
        return self._common_lookup(
            ...
            12,
            map_filler,
            "differential_closed_loop_feed_forward",
            True,
            float,
        )
    ...
    def get_differential_closed_loop_derivative_output(self) -> StatusSignal[float]:
        ...
        return self._common_lookup(
            ...
            13,
            map_filler,
            "differential_closed_loop_derivative_output",
            True,
            float,
        )
    ...
    def get_differential_closed_loop_output(self) -> StatusSignal[float]:
        ...
        return self._common_lookup(
            ...
            14,
            map_filler,
            "differential_closed_loop_output",
            True,
            float,
        )
    ...
    def get_differential_closed_loop_reference(self) -> StatusSignal[float]:
        ...
        return self._common_lookup(
            ...
            15,
            map_filler,
            "differential_closed_loop_reference",
            True,
            float,
        )
    ...
    def get_differential_closed_loop_reference_slope(self) -> StatusSignal[float]:
        ...
        return self._common_lookup(
            ...
            16,
            map_filler,
            "differential_closed_loop_reference_slope",
            True,
            float,
        )
    ...
    def get_differential_closed_loop_error(self) -> StatusSignal[float]:
        ...
        return self._common_lookup(
            ...
            17,
            map_filler,
            "differential_closed_loop_error",
            True,
            float,
        )
    ...
    def set_position(
        self, new_value: rotation, timeout_seconds: second = 0.050
    ) -> StatusCode:
        """
    ...
    def clear_sticky_fault_hardware(
        self, timeout_seconds: second = 0.050
    ) -> StatusCode:
        """
    ...
    def clear_sticky_fault_proc_temp(
        self, timeout_seconds: second = 0.050
    ) -> StatusCode:
        """
    ...
    def clear_sticky_fault_device_temp(
        self, timeout_seconds: second = 0.050
    ) -> StatusCode:
        """
    ...
    def clear_sticky_fault_undervoltage(
        self, timeout_seconds: second = 0.050
    ) -> StatusCode:
        """
    ...
    def clear_sticky_fault_boot_during_enable(
        self, timeout_seconds: second = 0.050
    ) -> StatusCode:
        """
    ...
    def clear_sticky_fault_bridge_brownout(
        self, timeout_seconds: second = 0.050
    ) -> StatusCode:
        """
    ...
    def clear_sticky_fault_remote_sensor_reset(
        self, timeout_seconds: second = 0.050
    ) -> StatusCode:
        """
    ...
    def clear_sticky_fault_missing_differential_fx(
        self, timeout_seconds: second = 0.050
    ) -> StatusCode:
        """
        ...
        return self.configurator.clear_sticky_fault_missing_differential_fx(
            timeout_seconds
        )

    def clear_sticky_fault_remote_sensor_pos_overflow(
        self, timeout_seconds: second = 0.050
    ) -> StatusCode:
        """
        ...
        return self.configurator.clear_sticky_fault_remote_sensor_pos_overflow(
            timeout_seconds
        )

    def clear_sticky_fault_over_supply_v(
        self, timeout_seconds: second = 0.050
    ) -> StatusCode:
        """
    ...
    def clear_sticky_fault_unstable_supply_v(
        self, timeout_seconds: second = 0.050
    ) -> StatusCode:
        """
    ...
    def clear_sticky_fault_reverse_hard_limit(
        self, timeout_seconds: second = 0.050
    ) -> StatusCode:
        """
    ...
    def clear_sticky_fault_forward_hard_limit(
        self, timeout_seconds: second = 0.050
    ) -> StatusCode:
        """
    ...
    def clear_sticky_fault_reverse_soft_limit(
        self, timeout_seconds: second = 0.050
    ) -> StatusCode:
        """
    ...
    def clear_sticky_fault_forward_soft_limit(
        self, timeout_seconds: second = 0.050
    ) -> StatusCode:
        """
    ...
    def clear_sticky_fault_remote_sensor_data_invalid(
        self, timeout_seconds: second = 0.050
    ) -> StatusCode:
        """
        ...
        return self.configurator.clear_sticky_fault_remote_sensor_data_invalid(
            timeout_seconds
        )

    def clear_sticky_fault_fused_sensor_out_of_sync(
        self, timeout_seconds: second = 0.050
    ) -> StatusCode:
        """
        ...
        return self.configurator.clear_sticky_fault_fused_sensor_out_of_sync(
            timeout_seconds
        )

    def clear_sticky_fault_stator_curr_limit(
        self, timeout_seconds: second = 0.050
    ) -> StatusCode:
        """
    ...
    def clear_sticky_fault_supply_curr_limit(
        self, timeout_seconds: second = 0.050
    ) -> StatusCode:
        """
