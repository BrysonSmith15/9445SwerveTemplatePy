...
class CoreCANcoder(ParentDevice):
    ...
    def __init__(self, device_id: int, canbus: str = ""):
        ...
        Native.instance().c_ctre_phoenix6_platform_sim_create(
            DeviceType.PRO_CANcoderType.value, device_id
        )
    ...
    def get_velocity(self) -> StatusSignal[rotations_per_second]:
        ...
        """
        return self._common_lookup(
            SpnValue.CANCODER_VELOCITY.value,
            0,
            None,
            "velocity",
            True,
    ...
    def get_position(self) -> StatusSignal[rotation]:
        ...
        """
        return self._common_lookup(
            SpnValue.CANCODER_POSITION.value, 0, None, "position", True, rotation
        )
    ...
    def get_absolute_position(self) -> StatusSignal[rotation]:
        ...
        """
        return self._common_lookup(
            SpnValue.CANCODER_ABS_POSITION.value,
            0,
            None,
            "absolute_position",
            True,
    ...
    def get_unfiltered_velocity(self) -> StatusSignal[rotations_per_second]:
        ...
        """
        return self._common_lookup(
            SpnValue.CANCODER_RAW_VEL.value,
            0,
            None,
            "unfiltered_velocity",
            True,
    ...
    def get_position_since_boot(self) -> StatusSignal[rotation]:
        ...
        """
        return self._common_lookup(
            SpnValue.CANCODER_RAW_POS.value,
            0,
            None,
            "position_since_boot",
            True,
    ...
    def get_supply_voltage(self) -> StatusSignal[volt]:
        ...
        """
        return self._common_lookup(
            SpnValue.CANCODER_SUPPLY_VOLTAGE.value,
            0,
            None,
            "supply_voltage",
            True,
    ...
    def get_magnet_health(self) -> StatusSignal[MagnetHealthValue]:
        ...
        """
        return self._common_lookup(
            SpnValue.CANCODER_MAG_HEALTH.value,
            0,
            None,
            "magnet_health",
            True,
    ...
    def get_fault_bad_magnet(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.FAULT_CANCODER_BAD_MAGNET.value,
            0,
            None,
            "fault_bad_magnet",
            True,
    ...
    def get_sticky_fault_bad_magnet(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.STICKY_FAULT_CANCODER_BAD_MAGNET.value,
            0,
            None,
            "sticky_fault_bad_magnet",
            True,
            bool,
        )
    ...
    def clear_sticky_fault_bad_magnet(
        self, timeout_seconds: second = 0.050
    ) -> StatusCode:
        """
