...
class CorePigeon2(ParentDevice):
    ...
    def __init__(self, device_id: int, canbus: str = ""):
        ...
        Native.instance().c_ctre_phoenix6_platform_sim_create(
            DeviceType.PRO_Pigeon2Type.value, device_id
        )
    ...
    def get_yaw(self) -> StatusSignal[degree]:
        ...
        """
        return self._common_lookup(
            SpnValue.PIGEON2_YAW.value, 0, None, "yaw", True, degree
        )
    ...
    def get_pitch(self) -> StatusSignal[degree]:
        ...
        """
        return self._common_lookup(
            SpnValue.PIGEON2_PITCH.value, 0, None, "pitch", True, degree
        )
    ...
    def get_roll(self) -> StatusSignal[degree]:
        ...
        """
        return self._common_lookup(
            SpnValue.PIGEON2_ROLL.value, 0, None, "roll", True, degree
        )
    ...
    def get_quat_w(self) -> StatusSignal[float]:
        ...
        """
        return self._common_lookup(
            SpnValue.PIGEON2_QUATW.value, 0, None, "quat_w", True, float
        )
    ...
    def get_quat_x(self) -> StatusSignal[float]:
        ...
        """
        return self._common_lookup(
            SpnValue.PIGEON2_QUATX.value, 0, None, "quat_x", True, float
        )
    ...
    def get_quat_y(self) -> StatusSignal[float]:
        ...
        """
        return self._common_lookup(
            SpnValue.PIGEON2_QUATY.value, 0, None, "quat_y", True, float
        )
    ...
    def get_quat_z(self) -> StatusSignal[float]:
        ...
        """
        return self._common_lookup(
            SpnValue.PIGEON2_QUATZ.value, 0, None, "quat_z", True, float
        )
    ...
    def get_gravity_vector_x(self) -> StatusSignal[float]:
        ...
        """
        return self._common_lookup(
            SpnValue.PIGEON2_GRAVITY_VECTORX.value,
            0,
            None,
            "gravity_vector_x",
            True,
    ...
    def get_gravity_vector_y(self) -> StatusSignal[float]:
        ...
        """
        return self._common_lookup(
            SpnValue.PIGEON2_GRAVITY_VECTORY.value,
            0,
            None,
            "gravity_vector_y",
            True,
    ...
    def get_gravity_vector_z(self) -> StatusSignal[float]:
        ...
        """
        return self._common_lookup(
            SpnValue.PIGEON2_GRAVITY_VECTORZ.value,
            0,
            None,
            "gravity_vector_z",
            True,
    ...
    def get_temperature(self) -> StatusSignal[celsius]:
        ...
        """
        return self._common_lookup(
            SpnValue.PIGEON2_TEMPERATURE.value, 0, None, "temperature", True, celsius
        )
    ...
    def get_no_motion_enabled(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.PIGEON2_NO_MOTION_CAL_ENABLED.value,
            0,
            None,
            "no_motion_enabled",
            True,
    ...
    def get_no_motion_count(self) -> StatusSignal[float]:
        ...
        """
        return self._common_lookup(
            SpnValue.PIGEON2_NO_MOTION_COUNT.value,
            0,
            None,
            "no_motion_count",
            True,
    ...
    def get_temperature_compensation_disabled(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.PIGEON2_TEMP_COMP_DISABLED.value,
            0,
            None,
            "temperature_compensation_disabled",
            True,
            bool,
        )
    ...
    def get_up_time(self) -> StatusSignal[second]:
        ...
        """
        return self._common_lookup(
            SpnValue.PIGEON2_UP_TIME.value, 0, None, "up_time", True, second
        )
    ...
    def get_accum_gyro_x(self) -> StatusSignal[degree]:
        ...
        """
        return self._common_lookup(
            SpnValue.PIGEON2_ACCUM_GYROX.value, 0, None, "accum_gyro_x", True, degree
        )
    ...
    def get_accum_gyro_y(self) -> StatusSignal[degree]:
        ...
        """
        return self._common_lookup(
            SpnValue.PIGEON2_ACCUM_GYROY.value, 0, None, "accum_gyro_y", True, degree
        )
    ...
    def get_accum_gyro_z(self) -> StatusSignal[degree]:
        ...
        """
        return self._common_lookup(
            SpnValue.PIGEON2_ACCUM_GYROZ.value, 0, None, "accum_gyro_z", True, degree
        )
    ...
    def get_angular_velocity_x_world(self) -> StatusSignal[degrees_per_second]:
        ...
        """
        return self._common_lookup(
            SpnValue.PIGEON2_ANGULAR_VELOCITY_XWORLD.value,
            0,
            None,
            "angular_velocity_x_world",
            True,
            degrees_per_second,
        )
    ...
    def get_angular_velocity_y_world(self) -> StatusSignal[degrees_per_second]:
        ...
        """
        return self._common_lookup(
            SpnValue.PIGEON2_ANGULAR_VELOCITY_YWORLD.value,
            0,
            None,
            "angular_velocity_y_world",
            True,
            degrees_per_second,
        )
    ...
    def get_angular_velocity_z_world(self) -> StatusSignal[degrees_per_second]:
        ...
        """
        return self._common_lookup(
            SpnValue.PIGEON2_ANGULAR_VELOCITY_ZWORLD.value,
            0,
            None,
            "angular_velocity_z_world",
            True,
            degrees_per_second,
        )
    ...
    def get_acceleration_x(self) -> StatusSignal[g]:
        ...
        """
        return self._common_lookup(
            SpnValue.PIGEON2_ACCELERATIONX.value, 0, None, "acceleration_x", True, g
        )
    ...
    def get_acceleration_y(self) -> StatusSignal[g]:
        ...
        """
        return self._common_lookup(
            SpnValue.PIGEON2_ACCELERATIONY.value, 0, None, "acceleration_y", True, g
        )
    ...
    def get_acceleration_z(self) -> StatusSignal[g]:
        ...
        """
        return self._common_lookup(
            SpnValue.PIGEON2_ACCELERATIONZ.value, 0, None, "acceleration_z", True, g
        )
    ...
    def get_supply_voltage(self) -> StatusSignal[volt]:
        ...
        """
        return self._common_lookup(
            SpnValue.PIGEON2_SUPPLY_VOLTAGE.value, 0, None, "supply_voltage", True, volt
        )
    ...
    def get_angular_velocity_x_device(self) -> StatusSignal[degrees_per_second]:
        ...
        """
        return self._common_lookup(
            SpnValue.PIGEON2_ANGULAR_VELOCITYX.value,
            0,
            None,
    ...
    def get_angular_velocity_y_device(self) -> StatusSignal[degrees_per_second]:
        ...
        """
        return self._common_lookup(
            SpnValue.PIGEON2_ANGULAR_VELOCITYY.value,
            0,
            None,
    ...
    def get_angular_velocity_z_device(self) -> StatusSignal[degrees_per_second]:
        ...
        """
        return self._common_lookup(
            SpnValue.PIGEON2_ANGULAR_VELOCITYZ.value,
            0,
            None,
    ...
    def get_magnetic_field_x(self) -> StatusSignal[microtesla]:
        ...
        """
        return self._common_lookup(
            SpnValue.PIGEON2_MAGNETIC_FIELDX.value,
            0,
            None,
            "magnetic_field_x",
            True,
    ...
    def get_magnetic_field_y(self) -> StatusSignal[microtesla]:
        ...
        """
        return self._common_lookup(
            SpnValue.PIGEON2_MAGNETIC_FIELDY.value,
            0,
            None,
            "magnetic_field_y",
            True,
    ...
    def get_magnetic_field_z(self) -> StatusSignal[microtesla]:
        ...
        """
        return self._common_lookup(
            SpnValue.PIGEON2_MAGNETIC_FIELDZ.value,
            0,
            None,
            "magnetic_field_z",
            True,
    ...
    def get_raw_magnetic_field_x(self) -> StatusSignal[microtesla]:
        ...
        """
        return self._common_lookup(
            SpnValue.PIGEON2_RAW_MAGNETIC_FIELDX.value,
            0,
            None,
            "raw_magnetic_field_x",
            True,
            microtesla,
        )
    ...
    def get_raw_magnetic_field_y(self) -> StatusSignal[microtesla]:
        ...
        """
        return self._common_lookup(
            SpnValue.PIGEON2_RAW_MAGNETIC_FIELDY.value,
            0,
            None,
            "raw_magnetic_field_y",
            True,
            microtesla,
        )
    ...
    def get_raw_magnetic_field_z(self) -> StatusSignal[microtesla]:
        ...
        """
        return self._common_lookup(
            SpnValue.PIGEON2_RAW_MAGNETIC_FIELDZ.value,
            0,
            None,
            "raw_magnetic_field_z",
            True,
            microtesla,
        )
    ...
    def get_fault_bootup_accelerometer(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.FAULT_PIGEON2_BOOTUP_ACCEL.value,
            0,
            None,
            "fault_bootup_accelerometer",
            True,
            bool,
        )
    ...
    def get_sticky_fault_bootup_accelerometer(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.STICKY_FAULT_PIGEON2_BOOTUP_ACCEL.value,
            0,
            None,
            "sticky_fault_bootup_accelerometer",
            True,
            bool,
        )
    ...
    def get_fault_bootup_gyroscope(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.FAULT_PIGEON2_BOOTUP_GYROS.value,
            0,
            None,
            "fault_bootup_gyroscope",
            True,
            bool,
        )
    ...
    def get_sticky_fault_bootup_gyroscope(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.STICKY_FAULT_PIGEON2_BOOTUP_GYROS.value,
            0,
            None,
            "sticky_fault_bootup_gyroscope",
            True,
            bool,
        )
    ...
    def get_fault_bootup_magnetometer(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.FAULT_PIGEON2_BOOTUP_MAGNE.value,
            0,
            None,
            "fault_bootup_magnetometer",
            True,
            bool,
        )
    ...
    def get_sticky_fault_bootup_magnetometer(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.STICKY_FAULT_PIGEON2_BOOTUP_MAGNE.value,
            0,
            None,
            "sticky_fault_bootup_magnetometer",
            True,
            bool,
        )
    ...
    def get_fault_boot_into_motion(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.FAULT_PIGEON2_BOOT_INTO_MOTION.value,
            0,
            None,
            "fault_boot_into_motion",
            True,
            bool,
        )
    ...
    def get_sticky_fault_boot_into_motion(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.STICKY_FAULT_PIGEON2_BOOT_INTO_MOTION.value,
            0,
            None,
            "sticky_fault_boot_into_motion",
            True,
            bool,
        )
    ...
    def get_fault_data_acquired_late(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.FAULT_PIGEON2_DATA_ACQUIRED_LATE.value,
            0,
            None,
            "fault_data_acquired_late",
            True,
            bool,
        )
    ...
    def get_sticky_fault_data_acquired_late(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.STICKY_FAULT_PIGEON2_DATA_ACQUIRED_LATE.value,
            0,
            None,
            "sticky_fault_data_acquired_late",
            True,
            bool,
        )
    ...
    def get_fault_loop_time_slow(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.FAULT_PIGEON2_LOOP_TIME_SLOW.value,
            0,
            None,
            "fault_loop_time_slow",
            True,
            bool,
        )
    ...
    def get_sticky_fault_loop_time_slow(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.STICKY_FAULT_PIGEON2_LOOP_TIME_SLOW.value,
            0,
            None,
            "sticky_fault_loop_time_slow",
            True,
            bool,
        )
    ...
    def get_fault_saturated_magnetometer(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.FAULT_PIGEON2_SATURATED_MAGNE.value,
            0,
            None,
            "fault_saturated_magnetometer",
            True,
            bool,
        )
    ...
    def get_sticky_fault_saturated_magnetometer(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.STICKY_FAULT_PIGEON2_SATURATED_MAGNE.value,
            0,
            None,
            "sticky_fault_saturated_magnetometer",
            True,
            bool,
        )
    ...
    def get_fault_saturated_accelerometer(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.FAULT_PIGEON2_SATURATED_ACCEL.value,
            0,
            None,
            "fault_saturated_accelerometer",
            True,
            bool,
        )
    ...
    def get_sticky_fault_saturated_accelerometer(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.STICKY_FAULT_PIGEON2_SATURATED_ACCEL.value,
            0,
            None,
            "sticky_fault_saturated_accelerometer",
            True,
            bool,
        )
    ...
    def get_fault_saturated_gyroscope(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.FAULT_PIGEON2_SATURATED_GYROS.value,
            0,
            None,
            "fault_saturated_gyroscope",
            True,
            bool,
        )
    ...
    def get_sticky_fault_saturated_gyroscope(self) -> StatusSignal[bool]:
        ...
        """
        return self._common_lookup(
            SpnValue.STICKY_FAULT_PIGEON2_SATURATED_GYROS.value,
            0,
            None,
            "sticky_fault_saturated_gyroscope",
            True,
            bool,
        )
    ...
    def clear_sticky_fault_bootup_accelerometer(
        self, timeout_seconds: second = 0.050
    ) -> StatusCode:
        """
        ...
        return self.configurator.clear_sticky_fault_bootup_accelerometer(
            timeout_seconds
        )

    def clear_sticky_fault_bootup_gyroscope(
        self, timeout_seconds: second = 0.050
    ) -> StatusCode:
        """
    ...
    def clear_sticky_fault_bootup_magnetometer(
        self, timeout_seconds: second = 0.050
    ) -> StatusCode:
        """
    ...
    def clear_sticky_fault_boot_into_motion(
        self, timeout_seconds: second = 0.050
    ) -> StatusCode:
        """
    ...
    def clear_sticky_fault_data_acquired_late(
        self, timeout_seconds: second = 0.050
    ) -> StatusCode:
        """
    ...
    def clear_sticky_fault_loop_time_slow(
        self, timeout_seconds: second = 0.050
    ) -> StatusCode:
        """
    ...
    def clear_sticky_fault_saturated_magnetometer(
        self, timeout_seconds: second = 0.050
    ) -> StatusCode:
        """
        ...
        return self.configurator.clear_sticky_fault_saturated_magnetometer(
            timeout_seconds
        )

    def clear_sticky_fault_saturated_accelerometer(
        self, timeout_seconds: second = 0.050
    ) -> StatusCode:
        """
        ...
        return self.configurator.clear_sticky_fault_saturated_accelerometer(
            timeout_seconds
        )

    def clear_sticky_fault_saturated_gyroscope(
        self, timeout_seconds: second = 0.050
    ) -> StatusCode:
        """
