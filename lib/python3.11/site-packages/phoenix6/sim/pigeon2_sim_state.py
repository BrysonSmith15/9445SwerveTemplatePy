...
class Pigeon2SimState:
    ...
    def set_raw_yaw(self, deg: degree) -> StatusCode:
        ...
        return StatusCode(
            Native.instance().c_ctre_phoenix6_platform_sim_set_physics_input(
                self.__device_type.value, self._id, ctypes.c_char_p(b"RawYaw"), deg
            )
        )
    ...
    def add_yaw(self, ddeg: degree) -> StatusCode:
        ...
        return StatusCode(
            Native.instance().c_ctre_phoenix6_platform_sim_set_physics_input(
                self.__device_type.value, self._id, ctypes.c_char_p(b"AddYaw"), ddeg
            )
        )
    ...
    def set_pitch(self, deg: degree) -> StatusCode:
        ...
        return StatusCode(
            Native.instance().c_ctre_phoenix6_platform_sim_set_physics_input(
                self.__device_type.value, self._id, ctypes.c_char_p(b"Pitch"), deg
            )
        )
    ...
    def set_roll(self, deg: degree) -> StatusCode:
        ...
        return StatusCode(
            Native.instance().c_ctre_phoenix6_platform_sim_set_physics_input(
                self.__device_type.value, self._id, ctypes.c_char_p(b"Roll"), deg
            )
        )
