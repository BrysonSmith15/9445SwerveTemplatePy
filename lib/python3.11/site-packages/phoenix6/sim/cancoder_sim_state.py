...
class CANcoderSimState:
    ...
    def set_velocity(self, rps: rotations_per_second) -> StatusCode:
        ...
        return StatusCode(
            Native.instance().c_ctre_phoenix6_platform_sim_set_physics_input(
                self.__device_type.value, self._id, ctypes.c_char_p(b"Velocity"), rps
            )
        )
    ...
    def set_magnet_health(self, value: MagnetHealthValue) -> StatusCode:
        ...
        return StatusCode(
            Native.instance().c_ctre_phoenix6_platform_sim_set_physics_input(
                self.__device_type.value,
                self._id,
                ctypes.c_char_p(b"MagnetHealth"),
                value.value,
            )
        )
