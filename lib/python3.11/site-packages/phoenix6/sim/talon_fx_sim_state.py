...
class TalonFXSimState:
    ...
    def __init__(
        self,
        device: "CoreTalonFX",
        orientation: ChassisReference = ChassisReference.CounterClockwise_Positive,
    ):
    ...
    def last_status_code(self) -> StatusCode:
        ...
        """
        return StatusCode(
            Native.instance().c_ctre_phoenix6_platform_sim_get_last_error(
                self.__device_type.value, self._id
            )
        )
    ...
    def motor_voltage(self) -> volt:
        ...
        Native.instance().c_ctre_phoenix6_platform_sim_get_physics_value(
            self.__device_type.value,
            self._id,
            ctypes.c_char_p(b"MotorVoltage"),
            ctypes.byref(value),
        )
    ...
    def torque_current(self) -> ampere:
        ...
        Native.instance().c_ctre_phoenix6_platform_sim_get_physics_value(
            self.__device_type.value,
            self._id,
            ctypes.c_char_p(b"TorqueCurrent"),
            ctypes.byref(value),
        )
        if self.orientation == ChassisReference.Clockwise_Positive:
            value.value = -value.value
    ...
    def supply_current(self) -> ampere:
        ...
        Native.instance().c_ctre_phoenix6_platform_sim_get_physics_value(
            self.__device_type.value,
            self._id,
            ctypes.c_char_p(b"SupplyCurrent"),
            ctypes.byref(value),
        )
        return value.value
    ...
    def set_supply_voltage(self, volts: volt) -> StatusCode:
        ...
        return StatusCode(
            Native.instance().c_ctre_phoenix6_platform_sim_set_physics_input(
                self.__device_type.value,
                self._id,
                ctypes.c_char_p(b"SupplyVoltage"),
                volts,
            )
        )
    ...
    def set_forward_limit(self, closed: bool) -> StatusCode:
        ...
        return StatusCode(
            Native.instance().c_ctre_phoenix6_platform_sim_set_physics_input(
                self.__device_type.value,
                self._id,
                ctypes.c_char_p(b"ForwardLimit"),
    ...
    def set_reverse_limit(self, closed: bool) -> StatusCode:
        ...
        return StatusCode(
            Native.instance().c_ctre_phoenix6_platform_sim_set_physics_input(
                self.__device_type.value,
                self._id,
                ctypes.c_char_p(b"ReverseLimit"),
                1.0 if closed else 0.0,
            )
        )
    ...
    def set_raw_rotor_position(self, rotations: rotation) -> StatusCode:
        ...
        return StatusCode(
            Native.instance().c_ctre_phoenix6_platform_sim_set_physics_input(
                self.__device_type.value,
                self._id,
                ctypes.c_char_p(b"RawRotorPosition"),
                rotations,
            )
        )
    ...
    def add_rotor_position(self, drotations: rotation) -> StatusCode:
        ...
        return StatusCode(
            Native.instance().c_ctre_phoenix6_platform_sim_set_physics_input(
                self.__device_type.value,
                self._id,
                ctypes.c_char_p(b"AddRotorPosition"),
                drotations,
            )
        )
    ...
    def set_rotor_velocity(self, rps: rotations_per_second) -> StatusCode:
        ...
        return StatusCode(
            Native.instance().c_ctre_phoenix6_platform_sim_set_physics_input(
                self.__device_type.value,
                self._id,
                ctypes.c_char_p(b"RotorVelocity"),
                rps,
            )
        )
    ...
    def set_rotor_acceleration(self, rpss: rotations_per_second_squared) -> StatusCode:
        ...
        return StatusCode(
            Native.instance().c_ctre_phoenix6_platform_sim_set_physics_input(
                self.__device_type.value,
                self._id,
                ctypes.c_char_p(b"RotorAcceleration"),
                rpss,
            )
        )
