...
class DifferentialMotionMagicDutyCycle:
    ...
    def __init__(
        ...
        differential_position: rotation,
        enable_foc: bool = True,
        target_slot: int = 0,
        differential_slot: int = 1,
        override_brake_dur_neutral: bool = False,
        limit_forward_motion: bool = False,
        limit_reverse_motion: bool = False,
    ):
    ...
    def _send_request(
        ...
        """
        return StatusCode(
            Native.instance().c_ctre_phoenix6_RequestControlDifferentialMotionMagicDutyCycle(
                ctypes.c_char_p(bytes(network, "utf-8")),
                device_hash,
                self.update_freq_hz,
                cancel_other_requests,
                self.target_position,
                self.differential_position,
                self.enable_foc,
                self.target_slot,
                self.differential_slot,
                self.override_brake_dur_neutral,
                self.limit_forward_motion,
                self.limit_reverse_motion,
            )
        )

    def with_target_position(
        self, new_target_position: rotation
    ...
    def with_differential_position(
        self, new_differential_position: rotation
    ) -> "DifferentialMotionMagicDutyCycle":
        """
    ...
    def with_target_slot(
        self, new_target_slot: int
    ) -> "DifferentialMotionMagicDutyCycle":
        """
    ...
    def with_differential_slot(
        self, new_differential_slot: int
    ) -> "DifferentialMotionMagicDutyCycle":
        """
    ...
    def with_override_brake_dur_neutral(
        self, new_override_brake_dur_neutral: bool
    ) -> "DifferentialMotionMagicDutyCycle":
        """
    ...
    def with_limit_forward_motion(
        self, new_limit_forward_motion: bool
    ) -> "DifferentialMotionMagicDutyCycle":
        """
    ...
    def with_limit_reverse_motion(
        self, new_limit_reverse_motion: bool
    ) -> "DifferentialMotionMagicDutyCycle":
        """
    ...
    def with_update_freq_hz(
        self, new_update_freq_hz: hertz
    ) -> "DifferentialMotionMagicDutyCycle":
        """
