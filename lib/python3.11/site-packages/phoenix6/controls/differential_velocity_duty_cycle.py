...
class DifferentialVelocityDutyCycle:
    ...
    def __init__(
        self,
        target_velocity: rotations_per_second,
    ...
    def _send_request(
        ...
        """
        return StatusCode(
            Native.instance().c_ctre_phoenix6_RequestControlDifferentialVelocityDutyCycle(
    ...
    def with_target_velocity(
        self, new_target_velocity: rotations_per_second
