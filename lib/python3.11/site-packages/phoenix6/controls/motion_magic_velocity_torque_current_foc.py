...
class MotionMagicVelocityTorqueCurrentFOC:
    ...
    def __init__(
        ...
        acceleration: rotations_per_second_squared = 0.0,
        enable_foc: bool = True,
        feed_forward: ampere = 0.0,
        slot: int = 0,
        override_coast_dur_neutral: bool = False,
    ...
    def _send_request(
        ...
        """
        return StatusCode(
            Native.instance().c_ctre_phoenix6_RequestControlMotionMagicVelocityTorqueCurrentFOC(
    ...
    def with_velocity(
        self, new_velocity: rotations_per_second
    ...
    def with_acceleration(
        self, new_acceleration: rotations_per_second_squared
    ) -> "MotionMagicVelocityTorqueCurrentFOC":
        """
    ...
    def with_feed_forward(
        self, new_feed_forward: ampere
    ) -> "MotionMagicVelocityTorqueCurrentFOC":
        """
    ...
    def with_override_coast_dur_neutral(
        self, new_override_coast_dur_neutral: bool
    ) -> "MotionMagicVelocityTorqueCurrentFOC":
        """
