...
class SignalLogger:
    ...
    def set_path(path: str) -> StatusCode:
        ...
        """
        return StatusCode(
            Native.instance().c_ctre_phoenix6_platform_set_logger_path(
                ctypes.c_char_p(bytes(path, "utf-8"))
            )
        )
    ...
    def enable_auto_logging(enable: bool) -> StatusCode:
        ...
        """
        return StatusCode(
            Native.instance().c_ctre_phoenix6_platform_enable_auto_logging(enable)
        )

    @staticmethod
    def write_raw(
        name: str, data: bytes, size: int, latency_seconds: second = 0
    ) -> StatusCode:
        """
        ...
        return StatusCode(
            Native.instance().c_ctre_phoenix6_platform_write_raw(
                ctypes.c_char_p(name_bytes), cdata, size, latency_seconds
            )
        )

    @staticmethod
    def write_boolean(
        name: str, value: bool, latency_seconds: second = 0
    ) -> StatusCode:
        """
        ...
        name_bytes = bytes(name, "utf-8")
        return StatusCode(
            Native.instance().c_ctre_phoenix6_platform_write_boolean(
                ctypes.c_char_p(name_bytes), value, latency_seconds
            )
        )

    @staticmethod
    def write_integer(
        name: str, value: int, units: str = "", latency_seconds: second = 0
    ) -> StatusCode:
        """
        ...
        return StatusCode(
            Native.instance().c_ctre_phoenix6_platform_write_integer(
                ctypes.c_char_p(name_bytes),
                value,
                ctypes.c_char_p(units_bytes),
                latency_seconds,
            )
        )
    ...
    @staticmethod
    def write_float(
        name: str, value: float, units: str = "", latency_seconds: second = 0
    ) -> StatusCode:
        """
        ...
        units_bytes = bytes(units, "utf-8")
        return StatusCode(
            Native.instance().c_ctre_phoenix6_platform_write_float(
                ctypes.c_char_p(name_bytes),
    ...
    def write_double(
        ...
        units_bytes = bytes(units, "utf-8")
        return StatusCode(
            Native.instance().c_ctre_phoenix6_platform_write_double(
                ctypes.c_char_p(name_bytes),
    ...
    def write_string(name: str, value: str, latency_seconds: second = 0) -> StatusCode:
        ...
        return StatusCode(
            Native.instance().c_ctre_phoenix6_platform_write_string(
                ctypes.c_char_p(name_bytes),
    ...
    @staticmethod
    def write_boolean_array(
        name: str, value: list[bool], latency_seconds: second = 0
    ) -> StatusCode:
        """
        ...
        return StatusCode(
            Native.instance().c_ctre_phoenix6_platform_write_boolean_array(
                ctypes.c_char_p(name_bytes), cvalue, count, latency_seconds
            )
        )

    @staticmethod
    def write_integer_array(
        name: str, value: list[int], units: str = "", latency_seconds: second = 0
    ) -> StatusCode:
        """
        ...
        return StatusCode(
            Native.instance().c_ctre_phoenix6_platform_write_integer_array(
                ctypes.c_char_p(name_bytes),
                cvalue,
                count,
                ctypes.c_char_p(units_bytes),
    ...
    def write_float_array(
        name: str, value: list[float], units: str = "", latency_seconds: second = 0
    ) -> StatusCode:
        """
        ...
        return StatusCode(
            Native.instance().c_ctre_phoenix6_platform_write_float_array(
                ctypes.c_char_p(name_bytes),
                cvalue,
                count,
                ctypes.c_char_p(units_bytes),
    ...
    def write_double_array(
        ...
        return StatusCode(
            Native.instance().c_ctre_phoenix6_platform_write_double_array(
                ctypes.c_char_p(name_bytes),
                cvalue,
                count,
                ctypes.c_char_p(units_bytes),
