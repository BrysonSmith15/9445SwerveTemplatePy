...
class Native:
    ...
    __c_args = [
        ...
        (
            ...
            [
                c.c_size_t,
                c.POINTER(SignalValues),
                c.POINTER(ReturnValues),
                c.c_char_p,
                c.c_bool,
                c.c_double,
            ],
        ...
        ("c_ctre_phoenix6_unmanaged_feed_enable", c.c_int, [c.c_int32]),
        ("c_ctre_phoenix6_unmanaged_get_api_compliancy", c.c_int, []),
        (
        ...
        ("c_ctre_phoenix6_free_memory", c.c_int, [c.POINTER(c.c_char_p)]),
        ("c_ctre_phoenix6_platform_canbus_is_network_fd", c.c_bool, [c.c_char_p]),
        (
        ...
        ("c_ctre_phoenix6_platform_sim_create", c.c_int32, [c.c_int, c.c_int]),
        ("c_ctre_phoenix6_platform_sim_destroy", c.c_int32, [c.c_int, c.c_int]),
        ("c_ctre_phoenix6_platform_sim_destroy_all", c.c_int32, []),
        (
        ...
        ("c_ctre_phoenix6_platform_sim_get_last_error", c.c_int32, [c.c_int, c.c_int]),
        ("c_ctre_phoenix6_platform_set_logger_path", c.c_int32, [c.c_char_p]),
        ("c_ctre_phoenix6_platform_start_logger", c.c_int32, []),
        ("c_ctre_phoenix6_platform_stop_logger", c.c_int32, []),
        ("c_ctre_phoenix6_platform_enable_auto_logging", c.c_int32, [c.c_bool]),
        (
        ...
        ("c_ctre_phoenix6_orchestra_Create", c.c_int, [c.POINTER(c.c_uint16)]),
        ("c_ctre_phoenix6_orchestra_Close", c.c_int, [c.c_uint16]),
        (
        ...
        ("c_ctre_phoenix6_orchestra_ClearDevices", c.c_int, [c.c_uint16]),
        ("c_ctre_phoenix6_orchestra_LoadMusic", c.c_int, [c.c_uint16, c.c_char_p]),
        ("c_ctre_phoenix6_orchestra_Play", c.c_int, [c.c_uint16]),
        ("c_ctre_phoenix6_orchestra_Pause", c.c_int, [c.c_uint16]),
        ("c_ctre_phoenix6_orchestra_Stop", c.c_int, [c.c_uint16]),
        (
    ...
    def instance(clazz):
        ...
        if clazz.__instance is None:
            ...
            ):  # Perform uname to delineate between mac and linux
                extension = ".so"
                prefix = "lib"
            else:
                extension = ".dylib"
            ...
            try:
                ...
                for lib in first_load:
                    clazz.__instance = c.cdll.LoadLibrary(
                        library_path + prefix + lib + extension
                    )
            except:
                try:
                    ...
                    raise FileNotFoundError(
                        "Could not find an appropriate CTRE library to load"
                    )
