...
class BooleanArrayTopic(Topic):
    ...
    def getEntry(
        self, defaultValue: list[int], options: PubSubOptions = ...
    ) -> BooleanArrayEntry:
        """
    ...
    def getEntryEx(
        self, typeString: str, defaultValue: list[int], options: PubSubOptions = ...
    ) -> BooleanArrayEntry:
        """
    ...
    def publishEx(
        self, typeString: str, properties: wpiutil.json, options: PubSubOptions = ...
    ) -> BooleanArrayPublisher:
        """
...
class BooleanTopic(Topic):
    ...
    def getEntry(
        self, defaultValue: bool, options: PubSubOptions = ...
    ) -> BooleanEntry:
        """
        Create a new entry for the topic.
    ...
    def getEntryEx(
        self, typeString: str, defaultValue: bool, options: PubSubOptions = ...
    ) -> BooleanEntry:
        """
        Create a new entry for the topic, with specific type string.
...
class DoubleArrayTopic(Topic):
    ...
    def getEntry(
        self, defaultValue: list[float], options: PubSubOptions = ...
    ) -> DoubleArrayEntry:
        """
        Create a new entry for the topic.
    ...
    def getEntryEx(
        self, typeString: str, defaultValue: list[float], options: PubSubOptions = ...
    ) -> DoubleArrayEntry:
        """
        Create a new entry for the topic, with specific type string.
...
class DoubleTopic(Topic):
    ...
    def getEntry(
        self, defaultValue: float, options: PubSubOptions = ...
    ) -> DoubleEntry:
        """
        Create a new entry for the topic.
    ...
    def getEntryEx(
        self, typeString: str, defaultValue: float, options: PubSubOptions = ...
    ) -> DoubleEntry:
        """
        Create a new entry for the topic, with specific type string.
...
class Event:
    ...
    def data(
        ...
        ConnectionInfo | TopicInfo | ValueEventData | LogMessage | TimeSyncEventData
    ): ...
    @property
    def flags(self) -> int:
        """
...
class IntegerTopic(Topic):
    ...
    def getEntryEx(
        self, typeString: str, defaultValue: int, options: PubSubOptions = ...
    ) -> IntegerEntry:
        """
        Create a new entry for the topic, with specific type string.
    ...
    def subscribe(
        self, defaultValue: int, options: PubSubOptions = ...
    ) -> IntegerSubscriber:
        """
        Create a new subscriber to the topic.
...
class NetworkTable:
    ...
    def addListener(
        self,
        eventMask: int,
        listener: typing.Callable[[NetworkTable, str, Event], None],
    ) -> int:
        """
    ...
    def addSubTableListener(
        self, listener: typing.Callable[[NetworkTable, str, NetworkTable], None]
    ) -> int:
        """
...
class NetworkTableEntry:
    ...
    class Flags:
        ...
        __members__: typing.ClassVar[
            dict[str, NetworkTableEntry.Flags]
        ]  # value = {'kPersistent': <Flags.kPersistent: 1>}
        kPersistent: typing.ClassVar[
            NetworkTableEntry.Flags
        ]  # value = <Flags.kPersistent: 1>
...
class NetworkTableInstance:
    ...
    class LogLevel:
        ...
        __members__: typing.ClassVar[
            dict[str, NetworkTableInstance.LogLevel]
        ...
        kLogCritical: typing.ClassVar[
            NetworkTableInstance.LogLevel
        ]  # value = <LogLevel.kLogCritical: 50>
        kLogDebug: typing.ClassVar[
            NetworkTableInstance.LogLevel
        ]  # value = <LogLevel.kLogDebug: 10>
        kLogDebug1: typing.ClassVar[
            NetworkTableInstance.LogLevel
        ]  # value = <LogLevel.kLogDebug1: 9>
        kLogDebug2: typing.ClassVar[
            NetworkTableInstance.LogLevel
        ]  # value = <LogLevel.kLogDebug2: 8>
        kLogDebug3: typing.ClassVar[
            NetworkTableInstance.LogLevel
        ]  # value = <LogLevel.kLogDebug3: 7>
        kLogDebug4: typing.ClassVar[
            NetworkTableInstance.LogLevel
        ]  # value = <LogLevel.kLogDebug4: 6>
        kLogError: typing.ClassVar[
            NetworkTableInstance.LogLevel
        ]  # value = <LogLevel.kLogError: 40>
        kLogInfo: typing.ClassVar[
            NetworkTableInstance.LogLevel
        ]  # value = <LogLevel.kLogInfo: 20>
        kLogWarning: typing.ClassVar[
            NetworkTableInstance.LogLevel
        ]  # value = <LogLevel.kLogWarning: 30>
        def __eq__(self, other: typing.Any) -> bool: ...
        def __getstate__(self) -> int: ...
        def __hash__(self) -> int: ...
        def __index__(self) -> int: ...
    ...
    class NetworkMode:
        ...
        __members__: typing.ClassVar[
            dict[str, NetworkTableInstance.NetworkMode]
        ]  # value = {'kNetModeNone': <NetworkMode.kNetModeNone: 0>, 'kNetModeServer': <NetworkMode.kNetModeServer: 1>, 'kNetModeClient3': <NetworkMode.kNetModeClient3: 2>, 'kNetModeClient4': <NetworkMode.kNetModeClient4: 4>, 'kNetModeLocal': <NetworkMode.kNetModeLocal: 16>, 'kNetModeStarting': <NetworkMode.kNetModeStarting: 8>}
        kNetModeClient3: typing.ClassVar[
            NetworkTableInstance.NetworkMode
        ]  # value = <NetworkMode.kNetModeClient3: 2>
        kNetModeClient4: typing.ClassVar[
            NetworkTableInstance.NetworkMode
        ]  # value = <NetworkMode.kNetModeClient4: 4>
        kNetModeLocal: typing.ClassVar[
            NetworkTableInstance.NetworkMode
        ]  # value = <NetworkMode.kNetModeLocal: 16>
        kNetModeNone: typing.ClassVar[
            NetworkTableInstance.NetworkMode
        ]  # value = <NetworkMode.kNetModeNone: 0>
        kNetModeServer: typing.ClassVar[
            NetworkTableInstance.NetworkMode
        ]  # value = <NetworkMode.kNetModeServer: 1>
        kNetModeStarting: typing.ClassVar[
            NetworkTableInstance.NetworkMode
        ]  # value = <NetworkMode.kNetModeStarting: 8>
        def __and__(self, other: typing.Any) -> typing.Any: ...
        def __eq__(self, other: typing.Any) -> bool: ...
        def __ge__(self, other: typing.Any) -> bool: ...
        def __getstate__(self) -> int: ...
    ...
    def addConnectionListener(
        self, immediate_notify: bool, callback: typing.Callable[[Event], None]
    ) -> int:
        """
    ...
    @typing.overload
    def addListener(
        self, topic: Topic, eventMask: int, listener: typing.Callable[[Event], None]
    ) -> int:
        """
    ...
    def addListener(
        ...
        eventMask: int,
        listener: typing.Callable[[Event], None],
    ) -> int:
        """
    ...
    def addLogger(
        self, minLevel: int, maxLevel: int, func: typing.Callable[[Event], None]
    ) -> int:
        """
    ...
    def configPythonLogging(
        self,
        *,
        min: NetworkTableInstance.LogLevel = ...,
        max: NetworkTableInstance.LogLevel = ...,
        name: str = "nt",
    ) -> None:
        """
    ...
    def startConnectionDataLog(
        self, log: wpiutil._wpiutil.log.DataLog, name: str
    ) -> int:
        """
    ...
    def startEntryDataLog(
        self, log: wpiutil._wpiutil.log.DataLog, prefix: str, logPrefix: str
    ) -> int:
        """
    ...
    def startServer(
        self,
        persist_filename: str = "networktables.json",
        listen_address: str = "",
        port3: int = 1735,
        port4: int = 5810,
    ) -> None:
...
class NetworkTableListener:
    ...
    @typing.overload
    def createListener(
        topic: Topic, mask: int, listener: typing.Callable[[Event], None]
    ) -> NetworkTableListener:
        """
    ...
    @typing.overload
    def createListener(
        subscriber: Subscriber, mask: int, listener: typing.Callable[[Event], None]
    ) -> NetworkTableListener:
        """
    ...
    @typing.overload
    def createListener(
        subscriber: MultiSubscriber, mask: int, listener: typing.Callable[[Event], None]
    ) -> NetworkTableListener:
        """
        Create a listener for topic changes on a subscriber. This does NOT keep the
        subscriber active.
    ...
    @typing.overload
    def createListener(
        entry: NetworkTableEntry, mask: int, listener: typing.Callable[[Event], None]
    ) -> NetworkTableListener:
        """
...
class NetworkTableType:
    ...
    kStringArray: typing.ClassVar[
        NetworkTableType
    ]  # value = <NetworkTableType.kStringArray: 64>
    kUnassigned: typing.ClassVar[
        NetworkTableType
    ]  # value = <NetworkTableType.kUnassigned: 0>
    def __eq__(self, other: typing.Any) -> bool: ...
    def __getstate__(self) -> int: ...
    def __hash__(self) -> int: ...
    def __index__(self) -> int: ...
...
class PubSubOptions:
    ...
    def __init__(
        ...
        *,
        pollStorage: int = 0,
        periodic: float = 0.1,
        excludePublisher: Publisher | None = None,
        sendAll: bool = False,
        topicsOnly: bool = False,
        keepDuplicates: bool = False,
        prefixMatch: bool = False,
        disableRemote: bool = False,
        disableLocal: bool = False,
...
class RawTopic(Topic):
    ...
    def getEntry(
        self,
        typeString: str,
        defaultValue: typing_extensions.Buffer,
        options: PubSubOptions = ...,
    ) -> RawEntry:
        """
        Create a new entry for the topic.
...
class StringArrayTopic(Topic):
    ...
    def getEntry(
        self, defaultValue: list[str], options: PubSubOptions = ...
    ) -> StringArrayEntry:
        """
        Create a new entry for the topic.
    ...
    def getEntryEx(
        self, typeString: str, defaultValue: list[str], options: PubSubOptions = ...
    ) -> StringArrayEntry:
        """
        Create a new entry for the topic, with specific type string.
...
class StringTopic(Topic):
    ...
    def getEntryEx(
        self, typeString: str, defaultValue: str, options: PubSubOptions = ...
    ) -> StringEntry:
        """
        Create a new entry for the topic, with specific type string.
    ...
    def subscribe(
        self, defaultValue: str, options: PubSubOptions = ...
    ) -> StringSubscriber:
        """
        Create a new subscriber to the topic.
...
class StructArrayTopic(Topic):
    ...
    def getEntry(
        self, defaultValue: list[typing.Any], options: PubSubOptions = ...
    ) -> StructArrayEntry:
        """
        Create a new entry for the topic.
    ...
    def publishEx(
        self, properties: wpiutil.json, options: PubSubOptions = ...
    ) -> StructArrayPublisher:
        """
        Create a new publisher to the topic, with type string and initial
        properties.
...
class StructTopic(Topic):
    ...
    def getEntry(
        self, defaultValue: typing.Any, options: PubSubOptions = ...
    ) -> StructEntry:
        """
        Create a new entry for the topic.
...
class Topic:
    ...
    def genericPublish(
        self, typeString: str, options: PubSubOptions = ...
    ) -> GenericPublisher:
        """
        Create a new publisher to the topic.
