...
def decodeClientPublishers(
    data: typing_extensions.Buffer,
) -> list[ClientPublisher] | None:
    """
...
def decodeClientSubscribers(
    data: typing_extensions.Buffer,
) -> list[ClientSubscriber] | None:
    """
...
def decodeTopicPublishers(
    data: typing_extensions.Buffer,
) -> list[TopicPublisher] | None:
    """
...
def decodeTopicSubscribers(
    data: typing_extensions.Buffer,
) -> list[TopicSubscriber] | None:
    """
