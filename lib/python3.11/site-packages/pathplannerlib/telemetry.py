...
class PPLibTelemetry:
    ...
    _inaccuracyPub: DoublePublisher = (
        NetworkTableInstance.getDefault()
        .getDoubleTopic("/PathPlanner/inaccuracy")
        .publish()
    )
    _posePub: DoubleArrayPublisher = (
        NetworkTableInstance.getDefault()
        .getDoubleArrayTopic("/PathPlanner/currentPose")
        .publish()
    )
    _pathPub: DoubleArrayPublisher = (
        NetworkTableInstance.getDefault()
        .getDoubleArrayTopic("/PathPlanner/activePath")
        .publish()
    )
    _targetPosePub: DoubleArrayPublisher = (
        NetworkTableInstance.getDefault()
    ...
    def setVelocities(
        ...
        PPLibTelemetry._velPub.set(
            [actual_vel, commanded_vel, actual_ang_vel, commanded_ang_vel]
        )
    ...
    def setTargetPose(pose: Pose2d) -> None:
        PPLibTelemetry._targetPosePub.set(
